...
export const metadata: Metadata = {
  title: 'Marriage & Relationship Astrology | Premium Kundali Matching & Manglik Dosh',
  ...
  keywords: 'Marriage Astrology, Premium Kundali Matching, Manglik Dosh, Love Marriage Prediction, Vedic Astrology Marriage, 7th House Astrology, Marriage Delay Remedies',
  openGraph: {
