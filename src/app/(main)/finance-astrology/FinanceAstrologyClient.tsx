...
const defaultFaqs = [
  { q: 'Kya main business shuru kar sakta hoon?', a: 'Business shuru karne ke liye 7th house aur Mercury (Buddh) ka majboot hona zaruri hai. Agar aapke chart mein strong Dhana Yogas hain, toh business aapko bahut safalta dega.' },
  { q: 'Share market mein invest karna chahiye ya nahi?', a: 'Share market aur trading 5th house (speculation) aur 8th house (sudden wealth) se dekha jata hai. Rahu aur Jupiter ki position decide karti hai ki aapko profit hoga ya loss.' },
  { q: 'Mera karza (debt) kab khatam hoga?', a: 'Karza 6th house se dekha jata hai. Jab bhi favorable planetary periods (Dasha) aati hain aur 6th lord ki shanti hoti hai, toh karza utarne ke raste khul jate hain.' },
  { q: 'Wealth aur finance badhane ke liye best remedies kya hain?', a: 'Dhan Laxmi Puja, Shree Yantra sthapana, aur Kanakdhara Stotram ka paath wealth attract karne ke liye sabse best maane jate hain. Specific gemstones aapke chart ke anusar suggest kiye jate hain.' },
  { q: 'Kya mujhe partnership mein business karna chahiye?', a: 'Ye 7th house par depend karta hai. Agar 7th house afflicted hai, toh partnership mein hamesha dhokha ya loss hota hai, aisi sthiti mein akele business karna better hai.' }
];

const defaultSuccessStories = [
  {
    name: 'Rahul B.',
    before: '"My business was drowning in huge debts. We were almost on the verge of declaring bankruptcy."',
    after: '"We performed the Dhan Laxmi Puja on their advice. Miraculously, new clients came in and we recovered all losses in 8 months."'
  },
  {
    name: 'Kavita S.',
    before: '"I started intraday trading in the stock market and lost a significant chunk of my life savings."',
    after: '"The astrologer checked my 5th house and advised strictly against intraday. Now doing long-term investments profitably."'
  },
  {
    name: 'Sanjay V.',
    before: '"My new tech startup failed to get any funding despite pitching to over 20 investors."',
    after: '"We changed the business name according to Numerology and strengthened the 7th house. Secured seed funding in just 45 days!"'
  },
  {
    name: 'Deepak M.',
    before: '"Money was coming in, but it was never staying in the bank. Unexpected expenses were draining us."',
    after: '"A simple but powerful remedy for the 2nd house fixed our cash flow leakages permanently. We finally bought a house!"'
  },
  {
    name: 'Pooja K.',
    before: '"I was about to sign a partnership deal with a close friend to open a new cafe franchise."',
    after: '"Kundali matching showed extreme betrayal in partnerships for me. I started alone and it\'s thriving. Saved my life savings!"'
  },
  {
    name: 'Arvind R.',
    before: '"Our ancestral property dispute was stuck in court for 5 years, draining our finances completely."',
    after: '"Specific Mars remedies suggested by the expert resolved the issue out of court within 3 months!"'
  }
];

export default function FinanceAstrologyClient({ 
  initialAstrologers = [], 
  ...
  useEffect(() => {
    ...
    const fetchSettings = async () => {
      ...
      try {
        const response = await apiClient.get('/smart-kundali-settings/finance-astrology');
        if (response.data) {
  ...
  const toggleFaq = (index: number) => {
    ...
    },
    {
      ...
      content: 'Wondering if trading is right for you? The 5th and 8th houses govern speculation and sudden gains. We predict if investments in stocks or crypto will yield profits.',
      icon: <Star className="w-6 h-6 text-[#059669]" />
    },
    {
      title: 'Property Investments',
      content: 'Is it a good time to buy property or real estate? The 4th house and Mars hold the key. We advise on the most auspicious timings for major asset purchases.',
      icon: <CheckCircle2 className="w-6 h-6 text-[#0ea5e9]" />
    },
    {
      title: 'Business Expansion',
      content: 'Ready to scale your business internationally? Transits of Jupiter and Rahu indicate the best periods for foreign expansion and massive business scaling.',
      ...
      <section className="relative w-full min-h-[550px] lg:min-h-[600px] flex flex-col lg:flex-row lg:items-center overflow-hidden pt-12 md:py-16 lg:py-20 z-10">
        ...
        <div className="absolute inset-0 z-0 hidden lg:flex justify-end pointer-events-none">
          <motion.img
            ...
            src={banner?.url || "/images/finance-hero.webp?v=2"}
            alt="Business & Finance Astrology Consultation"
        ...
        <div className="relative z-20 w-full px-6 md:px-10 mx-auto max-w-[1500px] flex-shrink-0 lg:-mt-16">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-[650px] lg:max-w-[800px]">
            ...
            <motion.h1 variants={fadeInUp} className="premium-serif font-bold text-[#3a1216] text-[38px] md:text-[56px] leading-[1.1] mb-6 tracking-tight">
              Unlock Wealth in Business & Finance <br />
            ...
            <motion.p variants={fadeInUp} className="text-[#5e4339] text-[16px] md:text-[18px] leading-relaxed mb-8 max-w-[550px] font-medium">
              Whether you're struggling with business losses, planning a new startup, dealing with debt, or seeking massive wealth accumulation — your Kundali holds precise, judgement-free answers.
            </motion.p>
          ...
          >
            <img
              src={banner?.url || "/images/finance-hero.webp?v=2"}
              alt="Business & Finance Astrology"
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
            <div className="max-w-2xl">
              <h2 className="premium-serif font-bold text-[36px] md:text-[42px] text-[#3a1216] mb-3">
                Consult Business & Finance <span className="text-[#d97706]">Specialists</span>
              </h2>
        ...
        <div className="max-w-[1500px] mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start mb-12 md:mb-16">
            <div className="flex-1 w-full">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#fdf3e7] text-[#d97706] text-sm font-semibold mb-4 border border-[#f0ddc0]/50">
                <Star className="w-4 h-4" /> Why Astrology for Wealth & Business?
              </div>
              <h2 className="premium-serif font-bold text-[28px] md:text-[42px] text-[#3a1216] leading-tight md:leading-[1.2] mb-5 md:mb-6">
                Decoding Your Financial Destiny <br className="hidden md:block" />With <span className="text-[#d97706]">Vedic Astrology</span>
              </h2>
              <p className="text-[#5e4339] text-[15.5px] md:text-[17px] leading-relaxed mb-4">
                Your ability to attract, accumulate, and grow wealth is deeply intertwined with the planetary alignments at your time of birth. Vedic astrology provides a razor-sharp blueprint of your financial strengths, hidden blockages, and the specific industries where you are destined to profit. Stop guessing and start building lasting wealth.
              </p>
              <p className="text-[#5e4339] text-[16px] md:text-[17px] leading-relaxed">
                The <strong className="text-[#3a1216]">2nd House</strong> (Dhana Bhava) and <strong className="text-[#3a1216]">11th House</strong> (Labha Bhava) in your birth chart represent your accumulated wealth and sudden gains. Along with Jupiter and Venus, these elements hold the key to answering when you'll recover from debts, if a new startup will succeed, and when to expect massive financial breakthroughs.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            ...
            <div className="p-6 md:p-8 rounded-[1.5rem] bg-[#fdfaf7] border border-[#f0ddc0]/80 shadow-[0_4px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_25px_rgba(217,119,6,0.08)] hover:border-[#d97706]/40 transition-all duration-300 group">
              ...
              <h3 className="premium-serif font-bold text-[22px] md:text-[24px] text-[#3a1216] mb-3">Dhana Yogas in Kundli</h3>
              <p className="text-[#5e4339] text-[14.5px] md:text-[15.5px] leading-relaxed">
                A "Dhana Yoga" is formed when the lords of the 1st, 2nd, 5th, 9th, and 11th houses connect. Depending on their strength, these planetary alignments can make an ordinary person a millionaire overnight. Our experts analyze your exact Dasha periods to predict when these yogas will activate and bring massive financial windfalls.
              </p>
            </div>
            ...
            <div className="p-6 md:p-8 rounded-[1.5rem] bg-[#fdfaf7] border border-[#f0ddc0]/80 shadow-[0_4px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_25px_rgba(34,197,94,0.08)] hover:border-[#22c55e]/40 transition-all duration-300 group">
              ...
              <h3 className="premium-serif font-bold text-[22px] md:text-[24px] text-[#3a1216] mb-3">Business & Partnership Safety</h3>
              <p className="text-[#5e4339] text-[14.5px] md:text-[15.5px] leading-relaxed">
                Before risking your capital in a new venture, it's crucial to check the <strong className="text-[#3a1216] font-semibold">7th House</strong>. If Rahu or Saturn afflicts this house, partnerships can lead to betrayals and severe losses. We evaluate business compatibility and suggest the most profitable sectors (e.g., tech, food, real estate) based on your Lagna.
              </p>
            </div>
            ...
            <div className="p-6 md:p-8 rounded-[1.5rem] bg-[#fdfaf7] border border-[#f0ddc0]/80 shadow-[0_4px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_25px_rgba(225,29,72,0.08)] hover:border-[#e11d48]/40 transition-all duration-300 group">
              ...
              <h3 className="premium-serif font-bold text-[22px] md:text-[24px] text-[#3a1216] mb-3">Escaping the Debt Trap</h3>
              <p className="text-[#5e4339] text-[14.5px] md:text-[15.5px] leading-relaxed">
                If money flows out faster than it comes in, a malefic <strong className="text-[#3a1216] font-semibold">12th House</strong> (Expenses) or <strong className="text-[#3a1216] font-semibold">6th House</strong> (Loans) is likely the culprit. We prescribe specific Vedic remedies, such as appeasing Mars (Mangal), chanting Kanakdhara Stotram, and performing targeted Homas to break the cycle of debt and restore financial stability.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1500px] mx-auto">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white text-[#d97706] text-sm font-semibold mb-4 border border-[#f0ddc0]/80 shadow-sm">
              <Key className="w-4 h-4" /> The Secrets of Wealth Astrology
            </div>
            <h2 className="premium-serif font-bold text-[32px] md:text-[40px] text-[#3a1216] mb-4 leading-tight">
              Planets, Houses & <span className="text-[#d97706]">Wealth Remedies</span>
            </h2>
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(217,119,6,0.06)] transition-all">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Jupiter (Guru):</strong> The ultimate Karaka (significator) of wealth, expansion, and gold. A strong Jupiter ensures lifelong abundance.</p>
                </li>
                <li className="flex gap-3">
                  <Star className="w-5 h-5 text-[#f59e0b] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Venus (Shukra):</strong> Governs luxury, cash flow, and vehicles. Venus decides the level of material comfort you will enjoy.</p>
                </li>
                <li className="flex gap-3">
                  <Star className="w-5 h-5 text-[#f59e0b] shrink-0 mt-0.5" />
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(217,119,6,0.06)] transition-all">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">2nd House:</strong> The 'Dhana Bhava', representing accumulated bank balance, fixed assets, and family wealth.</p>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0ea5e9] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">11th House:</strong> The 'Labha Bhava', house of gains, profits, and fulfillment of desires. It decides the ROI of your business.</p>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0ea5e9] shrink-0 mt-0.5" />
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(217,119,6,0.06)] transition-all">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Dhan Laxmi Puja:</strong> A highly potent ritual to remove financial curses and invite continuous cash flow into your business.</p>
                </li>
                <li className="flex gap-3">
                  <Heart className="w-5 h-5 text-[#d946ef] shrink-0 mt-0.5" />
