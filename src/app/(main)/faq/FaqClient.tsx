        ...
        <div className="max-w-[1000px] mx-auto px-4 md:px-8 relative z-10">
          ...
          <div className="mt-16 text-center bg-white p-8 md:p-12 rounded-3xl border border-[#f0ddc0] shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="https://wa.me/919810559439?text=Hello%2C%20I%20need%20astrology%20guidance" target="_blank" rel="noopener noreferrer" className="bg-white border-2 border-[#5c1420] text-[#5c1420] px-8 py-3.5 rounded-xl font-bold hover:bg-[#5c1420] hover:text-white transition-colors">WhatsApp Us
              </Link>
            </div>
          </div>
        </div>
