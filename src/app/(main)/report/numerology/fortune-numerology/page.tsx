      ...
      <section className="relative w-full pt-6 pb-12 overflow-hidden bg-[#7a4b3a]">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-4 text-center mt-2">
          <h1 className="text-[28px] md:text-[48px] lg:text-[58px] font-bold mb-3 font-serif leading-tight text-white drop-shadow-md">
            Fortune Numerology: Discover the Hidden Blueprint of Your Life

          </h1>
          <p className="text-[16px] md:text-[20px] text-white/100 mb-6 max-w-2xl mx-auto font-semibold drop-shadow-sm">
            Unlock Your Potential with the Power of Numbers
          </p>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-20">
          ...
          <div className="hidden md:flex md:w-1/2 justify-center">
            <img src={settings?.mockups?.pdf || "/images/vaidiktalk-kundli-mockup.webp"} alt="Premium Fortune Numerology Report" className="w-full max-w-[470px] rounded-xl mix-blend-multiply" onError={(e) => { e.currentTarget.src = 'https://placehold.co/400x550/f8f9fa/0f3b43?text=Numerology+Report' }} />
          </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            ...
            <div className="flex items-center gap-4 mb-4 md:mb-3">
              <div className="md:hidden shrink-0 w-[85px] sm:w-[100px] flex items-center justify-center">
                <img src={settings?.mockups?.pdf || "/images/vaidiktalk-kundli-mockup.webp"} alt="Premium Fortune Numerology Report" className="w-full h-auto object-contain drop-shadow-md rounded-sm mix-blend-multiply" onError={(e) => { e.currentTarget.src = 'https://placehold.co/400x550/f8f9fa/0f3b43?text=Numerology+Report' }} />
              </div>
              <h2 className="text-[22px] sm:text-3xl md:text-4xl font-serif font-bold text-[#5c1a1f] leading-tight">Premium Fortune Numerology Report</h2>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="md:w-[55%] lg:w-[60%] md:pl-6 lg:pl-10">
            ...
            <div className="space-y-6 mb-12">
              {[
                { t: 'Your most suitable numbers based on your birth date and name' },
                { t: 'Deep analysis of your Life Path and Destiny Numbers' },
                { t: 'Warnings about numbers you should avoid in business or life' },
                { t: 'Guidance on name correction and mobile number numerology' },
                { t: 'Simple household and charity-based remedies to balance karma' }
              ].map((item, i) => (
