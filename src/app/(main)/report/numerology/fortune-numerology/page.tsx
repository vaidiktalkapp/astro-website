...
const reportSections: ReportSection[] = [
  {
    heading: 'Overview',
    blocks: [
      { type: 'p', text: 'At VaidikTalk, we bring you a Complete Fortune Numerology Report — a powerful, personalized guide that dives deep into your number blueprint to help you realign your energies and unlock your full potential. The goal is to achieve a complete understanding about how planetary forces impact all aspects of human existence including work, social bonds, and money management.' },
      { type: 'p', text: 'A small energetic shift — a letter change, a new number, or vibration correction — can change the entire course of your life. Your name and numbers are not fixed; they are keys to your transformation. The document presents remedies together with observations which match the typical conditions of daily human life.' }
    ]
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'list', items: [
          'Product Name: Fortune Numerology',
          'Product Type: Personalized horoscope report',
          'Methodology: Traditional Fortune Numerology principles',
  ...
  },
  {
    ...
    blocks: [
      { type: 'p', text: 'The content of the book results from an evaluation of planetary positions through birth chart analysis which experts use to interpret Fortune Numerology. The arrangement of planetary houses plays an important role in understanding situational tendencies.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'People who want accessible astrological guidance without needing traditional consultation methods prefer to Shop Fortune Numerology online. The report format enables readers to understand its content through simple language which requires no specialized knowledge to comprehend.' }
    ]
  },
  {
...
const faqData: FaqItem[] = [
  {
    q: 'What is a Personalised Fortune Numerology?',
    content: [
      { type: 'p', text: 'A Personalised Fortune Numerology is an individualised astrological report based on the unique planetary positions in your birth chart, interpreted using Fortune Numerology principles. It focuses on karmic causes of life events and prescribes simple yet powerful remedies to balance planetary energies.' },
      { type: 'p', text: 'The term \u201cFortune Numerology\u201d means \u201cThe Red Book\u201d \u2014 containing ancient astrological wisdom that connects life with deeds (karma). Using your exact date, time, and place of birth, astrologers prepare a customised report offering precise insights and remedies tailored to your horoscope.' }
    ]
  },
  {
    q: 'How is Fortune Numerology different from traditional Vedic astrology?',
    content: [
      { type: 'p', text: 'While both share planetary science roots, their methods differ significantly:' },
      {
        type: 'table', headers: ['Aspect', 'Vedic Astrology', 'Fortune Numerology Astrology'], rows: [
      ...
      { type: 'p', text: 'Thus, Fortune Numerology is known for its practicality and real-life applications.' }
    ]
  },
  {
    q: 'What details are required to prepare a Personalised Fortune Numerology?',
    content: [
      { type: 'list', items: ['Full Name', 'Date of Birth (DD/MM/YYYY)', 'Exact Time of Birth', 'Place of Birth (City, State, Country)'] },
      { type: 'p', text: 'Using these details, astrologers prepare your unique Fortune Numerology chart, interpret it, and provide personalised remedies and predictions.' }
    ]
  },
  {
    q: 'What kind of insights does a Personalised Fortune Numerology offer?',
    content: [
      {
        type: 'list', items: [
  ...
  {
    q: 'What are Fortune Numerology remedies, and how do they work?',
    content: [
      { type: 'p', text: 'Fortune Numerology remedies (Upaay) are simple and powerful karmic corrections. They include:' },
      {
        type: 'list', items: [
  ...
  {
    q: 'Is Fortune Numerology astrology scientific or spiritual?',
    content: [
      { type: 'p', text: 'Fortune Numerology blends science, logic, and spirituality. It simplifies planetary analysis into house-based systems and uses karmic remedies for energy correction and psychological healing \u2014 creating spiritual and practical balance.' }
    ]
  },
  {
    q: 'What are the benefits of having a Personalised Fortune Numerology report?',
    content: [
      {
        type: 'list', items: [
  ...
  {
    q: 'Can Fortune Numerology remedies remove doshas like Manglik or Kaal Sarp Dosh?',
    content: [
      { type: 'p', text: 'Yes, Fortune Numerology remedies can help reduce doshas like Manglik, Kaal Sarp, or Shani Dosh. Remedies include donations, feeding the poor, or offering oil to Shani temples \u2014 focusing on karma correction rather than costly rituals.' }
    ]
  },
  {
    q: 'How frequently should one consult their Personalised Fortune Numerology?',
    content: [
      { type: 'p', text: 'It\u2019s ideal to review your Fortune Numerology every 5\u20137 years or during major life transitions like marriage, job change, or health shifts. Planetary positions remain fixed, but Dasha periods change life patterns \u2014 making updates essential.' }
    ]
  },
  {
    q: 'Where can one get an authentic Personalised Fortune Numerology prepared?',
    content: [
      { type: 'p', text: 'For authentic reports, consult expert Fortune Numerology astrologers. VaidikTalk offers accurate, personalised Fortune Numerology reports prepared using your complete birth details, including:' },
      {
        type: 'list', items: [
...
export default function LalKitabPage() {
  ...
  const { formData, handleChange, handleSubmit, isProcessing } = useReportBooking({
    ...
    amount: settings?.price || settings?.discountedPrice || 449,
  });
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        const res = await apiClient.get('/smart-kundali-settings/fortune-numerology');
    ...
    <div className="w-full min-h-screen bg-transparent font-sans text-gray-800 relative selection:bg-[#ee6c1e] selection:text-white">
      ...
      <section className="relative w-full min-h-[550px] lg:min-h-[600px] flex flex-col md:flex-row md:items-center overflow-hidden pt-12 md:py-20 z-10">
        <div className="absolute inset-0 z-0 hidden lg:flex justify-end pointer-events-none">
          <img
            src={settings?.banner?.url || "/images/fortune-numerology.webp"}
            alt="Fortune Numerology"
            className="h-full lg:w-[48%] object-cover object-center mix-blend-multiply opacity-95 lg:-translate-x-1"
        ...
        <div className="relative z-20 w-full px-5 md:px-10 mx-auto max-w-[1300px] flex-shrink-0 md:-mt-8 lg:-mt-12">
          <div className="max-w-[650px] lg:max-w-[750px]">
            ...
            <div className="flex items-center gap-3 md:gap-4 mb-6 md:mb-7 flex-wrap">
              <div className="flex items-baseline gap-2 md:gap-3">
                <span className="premium-serif text-[36px] md:text-[42px] font-bold text-[#5c1420]">₹{settings?.discountedPrice || 449}</span>
          ...
          <div className="block lg:hidden mt-12 mb-4">
            <img
              src="/images/fortune-numerology.webp"
              alt="Fortune Numerology"
      ...
      <section className="py-16 md:py-24 bg-[#fffdf8] border-y border-[#ebdcc7]">
        ...
        <SectionHeading title="How Fortune Numerology Report Works" />
      ...
      <section className="py-16 md:py-24">
        ...
        <SectionHeading title="Why Choose Fortune Numerology Report?" />
        <div className="max-w-[1140px] mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-[#ebdcc7]">
            ...
            <div className="bg-white border-t md:border-t-0 md:border-l border-[#ebdcc7]">
              <div className="p-6 md:p-8 border-b border-[#ebdcc7] bg-[#5c1a1f]">
                <strong className="premium-serif block text-[22px] md:text-[24px] font-bold text-[#d4af37] mb-1">Fortune Numerology</strong>
                <span className="text-[13px] md:text-[14px] text-[#e8d8c0]">Fortune Numerology Report Features</span>
              </div>
              <ul className="p-6 md:p-8 space-y-4 md:space-y-5">
                {[
      ...
      <section className="py-16 md:py-24" id="faqSection">
        <Kicker text="FAQs" />
        <SectionHeading title="Personalised Fortune Numerology FAQs" />
        <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div className="max-w-[900px] mx-auto px-4 md:px-6">
          <div className="bg-[#fffdf8] border border-[#ebdcc7] shadow-[0_15px_40px_rgba(0,0,0,0.05)] rounded-2xl p-8 md:p-16 text-center relative overflow-hidden">
            ...
            <a href="#order-form" className="inline-flex justify-center w-full sm:w-auto items-center gap-2 bg-[#d4af37] hover:bg-[#c29f2f] text-[#3a1216] font-bold text-[16px] md:text-[17px] px-8 md:px-10 py-4 rounded-md transition-colors shadow-md relative z-10">
              Book Now @ ₹699 <ArrowRight className="w-5 h-5" />
            </a>
          </div>
        </div>
      </section>
