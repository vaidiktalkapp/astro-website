...
async function fetchSettings() {
  try {
    const res = await fetch(`${API_URL}/smart-kundali-settings/fortune-numerology`, {
      next: { revalidate: 60 }
    });
...
const faqData: FaqItem[] = [
  {
    q: 'What is a Pro Fortune Numerology Report?',
    content: [
      {
        type: 'p',
  ...
  {
    q: 'How does a Pro Fortune Numerology Report differ from a traditional Numerology Report?',
    content: [
      { type: 'p', text: 'While both are based on Vedic astrology, a Pro Fortune Numerology Report is a next-generation horoscope analysis:' },
      {
        type: 'table',
        headers: ['Aspect', 'Traditional Numerology Report', 'Pro Fortune Numerology Report (10 Years)'],
        rows: [
      ...
      { type: 'p', text: 'The Numerology Report blends ancient wisdom with modern precision, providing a forward-looking view rather than static birth data.' }
    ]
  },
  {
    q: 'What does the Pro Fortune Numerology Report include?',
    content: [
      {
        type: 'list',
        items: [
          'Detailed Birth Chart (Janma Numerology Report) with Lagna, Moon and Navamsa charts',
          'Soul Urge and Subconscious Self Evaluation',
          ...
          'Innate Talents and Personal Growth Opportunities'
        ]
      }
    ]
  },
  {
    q: 'How accurate are the predictions in the Pro Fortune Numerology Report?',
    content: [
  ...
  {
    q: 'What time period does the 10-year Pro Fortune Numerology Report cover?',
    content: [
      { type: 'p', text: 'The Pro Fortune Numerology Report provides forecasts for 10 continuous years from the preparation date. For example, a Numerology Report prepared in October 2025 will cover 2025–2035, helping plan career, finance, family and spiritual decisions with foresight.' }
    ]
  },
  {
    q: 'Who should get a Pro Fortune Numerology Report?',
    content: [
  ...
  {
    q: 'What remedies are suggested in the Pro Fortune Numerology Report?',
    content: [
      {
        type: 'list',
        items: [
  ...
  {
    q: 'Is the Pro Fortune Numerology Report available in digital formats?',
    content: [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: 'The astrologers prepare your 10-year Numerology Report and deliver it digitally or in printed form within a few days.' }
    ]
  },
  {
    q: 'What are the benefits of having a Pro Fortune Numerology Report?',
    content: [
      {
        type: 'list',
        items: [
  ...
  const defaultTestimonials = [
    {
      ...
      city: "Delhi",
      date: "October 2025",
      review: "The 10-year Numerology Report gave me exactly what I needed—clarity. The predictions regarding my career switch and timing were incredibly accurate. Highly recommend it to anyone feeling stuck.",
      initial: "R",
      color: "#5c1a1f"
    },
    {
      ...
      city: "Ahmedabad",
      date: "September 2025",
      review: "I was looking for something more than just basic astrology. The Numerology Report provided a year-by-year breakdown of my finance and health. It’s beautifully designed and very easy to understand.",
      initial: "S",
      color: "#d97706"
    },
    {
      ...
      <section className="relative w-full pt-6 pb-16 overflow-hidden bg-[#7a4b3a]">
        ...
        <div className="absolute inset-0 z-0 bg-[#4c2918]">
          {settings?.banner?.url && /\.(mp4|webm|mov)(\?.*)?$/i.test(settings.banner.url) ? (
            ...
            <img src={settings.banner.url} alt="Pro Fortune Numerology Report" className="w-full h-full object-cover object-center opacity-100" />
          ) : (
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-4 text-center mt-2">
          ...
          <p className="text-[16px] md:text-[20px] text-white/100 mb-6 max-w-2xl mx-auto font-semibold drop-shadow-sm">{settings?.heroSubheading || "Premium Personalized Numerology Report by India's Most Trusted Astrologer"}</p>

          <Link href="/report/numerology/fortune-numerology/checkout" className="inline-block bg-white text-[#b06126] font-bold text-[16px] md:text-[18px] px-10 py-3.5 md:py-4 rounded-xl shadow-lg hover:scale-105 transition-transform mb-6">
            {settings?.heroCtaText || "Get Your Numerology Report Now"} @ <span className="line-through text-[#3a1216] mx-1">₹1799</span> ₹649
          </Link>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-20">
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            ...
            <Link href="/report/numerology/fortune-numerology/checkout" className="inline-block bg-[#d68636] text-white font-bold text-[16px] px-10 py-4 rounded-lg shadow-lg hover:bg-[#b06126] transition-colors w-full md:w-auto text-center">
              {settings?.imageSectionCtaText || "Get Your Numerology Report Now →"}
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-[#fdfaf6]">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="md:w-[55%] lg:w-[60%] md:pl-6 lg:pl-10">
            ...
            <a href="/report/numerology/fortune-numerology/checkout" className="inline-block bg-[#d68636] text-white font-bold text-[16px] px-10 py-4 rounded-xl shadow-md hover:bg-[#8c4d1e] transition-colors w-full md:w-auto text-center">
              {settings?.videoSectionCtaText || "Get Your Numerology Report Now →"}
            </a>
          </div>
        </div>
      </section>
      ...
      {validVideos.length > 0 && (
        <section className="py-16 md:py-24 bg-[#fdfaf6] border-y border-[#ebdcc7] overflow-hidden">
          <div className="max-w-[1400px] mx-auto px-4 text-center">
            <h2 className="text-[28px] md:text-[36px] font-serif font-bold text-[#5c1a1f] mb-12">Watch Numerology Report Insights</h2>
    ...
    <div key={i} className="w-[280px] sm:w-[320px] md:w-[360px] lg:w-[400px] aspect-video bg-black rounded-2xl overflow-hidden relative shadow-xl snap-center flex-shrink-0 border-[3px] border-white">
      ...
      <section className="pt-16 pb-28 md:py-24 bg-[#fdfaf6] border-t border-[#ebdcc7]">
        <div className="max-w-[800px] mx-auto px-4 text-center">
          ...
          <p className="text-center text-[#3a1216] text-[15px] md:text-[16px] mb-10 max-w-[600px] mx-auto">Get your Premium Personalized 10-Year Vaidik Numerology Report today and gain crystal clear insights into your career, marriage, and wealth.</p>
          <Link href="/report/numerology/fortune-numerology/checkout" className="inline-block bg-[#d68636] text-white font-bold text-[18px] px-12 py-4 rounded-xl shadow-[0_8px_20px_rgba(214,134,54,0.3)] hover:bg-[#b06126] transition-all hover:scale-105">
            {settings?.bottomCtaText || "Unlock Your Future Now"}
          </Link>
        </div>
      </section>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-3 z-[60] shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
        <Link href="/report/numerology/fortune-numerology/checkout" className="flex items-center justify-center bg-[#b06126] text-white font-bold text-[16px] py-3.5 rounded-lg shadow-sm hover:bg-[#8c481c] transition-colors w-full">
          {settings?.stickyCtaText || "Get Your Report →"}
        </Link>
      </div>
