...
function SuccessContent() {
  ...
  useEffect(() => {
    ...
    fetch(`${apiUrl}/smart-kundali-settings/vaidik-smart-kundali-10-years`)
      .then(res => res.json())
        ...
        <div className="p-8 md:p-12 flex flex-col items-center justify-center text-center relative w-full h-full min-h-[400px]">
          {isGenerating ? (
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-[24px] font-bold text-[#5c1a1f] mb-3">Generating Your {settings?.productHeading || "Smart Kundali"}</h2>
            ...
            <div className="flex flex-col items-center w-full">
              ...
              <h2 className="text-[24px] font-bold text-[#5c1a1f] mb-3">{settings?.productHeading ? settings.productHeading + " Ready!" : "Kundali Ready!"}</h2>
              <p className="text-[15px] text-[#3a1216]/80 leading-relaxed font-medium mb-8">
                Your {settings?.productHeading || "Premium Personalised Kundli"} has been successfully generated.
              </p>
