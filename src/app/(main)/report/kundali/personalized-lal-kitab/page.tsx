          ...
          <div className="w-full md:w-1/2 flex flex-col">
            ...
            <div className="flex items-center gap-4 mb-4 md:mb-3">
              <div className="md:hidden shrink-0 w-[85px] sm:w-[100px] flex items-center justify-center">
                <img src={settings?.mockups?.pdf || "/images/vaidiktalk-kundli-mockup.webp"} alt="Premium Personalized Lal Kitab" className="w-full h-auto object-contain drop-shadow-md rounded-sm mix-blend-multiply" onError={(e) => { e.currentTarget.src = 'https://placehold.co/400x550/f8f9fa/0f3b43?text=Numerology+Report' }} />
              </div>
              <h2 className="text-[22px] sm:text-3xl md:text-4xl font-serif font-bold text-[#5c1a1f] leading-tight">Premium Personalized Lal Kitab</h2>
            </div>
