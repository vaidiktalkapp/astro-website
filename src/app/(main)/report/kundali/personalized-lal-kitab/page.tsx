...
async function fetchSettings() {
  try {
    const res = await fetch(`${API_URL}/smart-kundali-settings/personalized-lal-kitab`, { next: { revalidate: 60 } });
...
const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    content: [
      { type: 'p', text: 'For authentic reports, consult expert Lal Kitab astrologers. AstroSolution offers accurate, personalised Lal Kitab reports prepared using your complete birth details, including:' },
      {
        type: 'list', items: [
...
export default async function PersonalizedLalKitabPage() {
      ...
      <section className="relative w-full pt-6 pb-12 overflow-hidden bg-[#7a4b3a]">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-4 text-center mt-2">
          <h1 className="text-[28px] md:text-[48px] lg:text-[58px] font-bold mb-3 font-serif leading-tight text-white drop-shadow-md">
            {settings?.heroHeading || "Personalized Lal Kitab: Unlock the Secrets of Lal Kitab"}
          </h1>
          <p className="text-[16px] md:text-[20px] text-white/100 mb-6 max-w-2xl mx-auto font-semibold drop-shadow-sm">
            {settings?.heroSubheading || "Simple Remedies for a Harmonious Life"}
          </p>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-20">
          ...
          <div className="hidden md:flex md:w-1/2 justify-center">
            <img src={settings?.mockups?.pdf || "/images/AstroSolution-kundli-mockup.webp"} alt="Premium Personalized Lal Kitab" className="w-full max-w-[470px] rounded-xl mix-blend-multiply" />
          </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            ...
            <div className="flex items-center gap-4 mb-4 md:mb-3">
              <div className="md:hidden shrink-0 w-[85px] sm:w-[100px] flex items-center justify-center">
                <img src={settings?.mockups?.pdf || "/images/AstroSolution-kundli-mockup.webp"} alt="Premium Personalized Lal Kitab" className="w-full h-auto object-contain drop-shadow-md rounded-sm mix-blend-multiply" />
              </div>
              <h2 className="text-[22px] sm:text-3xl md:text-4xl font-serif font-bold text-[#5c1a1f] leading-tight">{settings?.productHeading || "Premium Personalized Lal Kitab"}</h2>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="md:w-[55%] lg:w-[60%] md:pl-6 lg:pl-10">
            ...
            <a href="/report/numerology/personalized-lal-kitab/checkout" className="inline-block bg-[#d68636] text-white font-bold text-[16px] px-10 py-4 rounded-xl shadow-md hover:bg-[#b06126] transition-colors w-full md:w-auto text-center">
              {settings?.videoSectionCtaText || "Order Your Personalized Lal Kitab →"}
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-[#fdfaf6] text-white">
        <div className="max-w-[800px] mx-auto px-4 text-center">
          ...
          <Link href="/report/numerology/personalized-lal-kitab/checkout" className="inline-block bg-[#d68636] text-white font-bold text-[18px] px-12 py-4 rounded-xl shadow-[0_8px_20px_rgba(214,134,54,0.3)] hover:bg-[#b06126] transition-all hover:scale-105">
            {settings?.bottomCtaText || "Book Personalized Lal Kitab"}
          </Link>
        </div>
      </section>
