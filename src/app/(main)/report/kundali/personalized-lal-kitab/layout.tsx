...
const REPORT_SLUG = 'personalized-lal-kitab';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = settings?.seoTitle || 'Personalized Lal Kitab Horoscope & Remedies';
  const description = settings?.seoDescription || 'Get your personalized Lal Kitab horoscope. Discover powerful, practical remedies for career, finance, and health issues based on ancient Lal Kitab astrology.';
  const keywords = settings?.seoKeywords || 'Lal Kitab, Lal Kitab Horoscope, Lal Kitab Remedies, Personalized Astrology, Vedic Astrology';
  ...
  return {
    ...
    alternates: {
      canonical: `https://AstroSolution.com/report/kundali/${REPORT_SLUG}`,
    },
    robots: {
      index: true,
      follow: true,
    ...
    openGraph: {
      title,
      description,
      url: `https://AstroSolution.com/report/kundali/${REPORT_SLUG}`,
