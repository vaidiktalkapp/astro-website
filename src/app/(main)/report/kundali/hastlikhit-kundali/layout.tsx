...
const REPORT_SLUG = 'hastlikhit-kundali';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = settings?.seoTitle || 'Hastlikhit Kundali - Authentic Handwritten Horoscope';
  const description = settings?.seoDescription || 'Get your authentic Hastlikhit Kundali prepared by experienced astrologers. Receive a beautifully handwritten horoscope based on traditional Vedic astrology.';
  const keywords = settings?.seoKeywords || 'Hastlikhit Kundali, Handwritten Kundli, Traditional Horoscope, Vedic Astrology';
