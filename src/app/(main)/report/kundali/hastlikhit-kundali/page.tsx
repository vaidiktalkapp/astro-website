...
const reportSections: ReportSection[] = [
  {
    heading: 'Overview',
    blocks: [
      { type: 'p', text: 'The creation of personalized astrological documents requires the evaluation of individual planetary combinations which must follow traditional Hastlikhit Kundali principles. The book uses this method to deliver personal insights which reflect actual human situations instead of presenting theoretical outcomes. The goal is to achieve a complete understanding about how planetary forces impact all aspects of human existence including work, social bonds, and money management.' },
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'list', items: [
          'Product Name: Hastlikhit Kundali',
          'Product Type: Personalized horoscope report',
          'Methodology: Traditional Hastlikhit Kundali principles',
  ...
  },
  {
    ...
    blocks: [
      { type: 'p', text: 'The content of the book results from an evaluation of planetary positions through birth chart analysis which experts use to interpret Hastlikhit Kundali. The arrangement of planetary houses plays an important role in understanding situational tendencies.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'People who want accessible astrological guidance without needing traditional consultation methods prefer to Shop Hastlikhit Kundali online. The report format enables readers to understand its content through simple language which requires no specialized knowledge to comprehend.' }
    ]
  },
  {
...
const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    content: [
      { type: 'p', text: 'For authentic reports, consult expert Hastlikhit Kundali astrologers. VaidikTalk offers accurate, personalised Hastlikhit Kundali reports prepared using your complete birth details, including:' },
      {
        type: 'list', items: [
...
export default function LalKitabPage() {
  ...
  const { formData, handleChange, handleSubmit, isProcessing } = useReportBooking({
    ...
    amount: settings?.price || settings?.discountedPrice || 999,
  });
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        const res = await apiClient.get('/smart-kundali-settings/hastlikhit-kundali');
    ...
    <div className="w-full min-h-screen bg-transparent font-sans text-gray-850 relative selection:bg-[#ee6c1e] selection:text-white">
      ...
      <section className="relative w-full min-h-[550px] lg:min-h-[600px] flex flex-col md:flex-row md:items-center overflow-hidden pt-12 md:py-20 z-10">
        <div className="absolute inset-0 z-0 hidden lg:flex justify-end pointer-events-none">
          <img
            src={settings?.banner?.url || "/images/hastlikhit-kundali.webp"}
            alt="Hastlikhit Kundali"
        ...
        <div className="relative z-20 w-full px-5 md:px-10 mx-auto max-w-[1300px] flex-shrink-0 md:-mt-8 lg:-mt-12">
          <div className="max-w-[650px] lg:max-w-[750px]">
            ...
            <p className="text-[15.5px] sm:text-[17px] md:text-[19px] text-[#412a1e] font-medium leading-[1.6] mb-6 md:mb-8 max-w-[560px]">
              At Vaidik Talk, we honour the timeless power of traditional Vedic astrology through our Hasth Likhit Kundali – a meticulously Hastlikhit birth chart that offers spiritual authenticity and personalized insight.
            </p>

            <div className="flex items-center gap-3 md:gap-4 mb-6 md:mb-7 flex-wrap">
              <div className="flex items-baseline gap-2 md:gap-3">
                <span className="premium-serif text-[36px] md:text-[42px] font-bold text-[#5c1420]">₹{settings?.discountedPrice || 999}</span>
          ...
          <div className="block lg:hidden mt-12 mb-4">
            <img
              src="/images/hastlikhit-kundali.webp"
              alt="Hastlikhit Kundali"
      ...
      <section className="py-16 md:py-24 bg-[#fffdf8] border-y border-[#ebdcc7]">
        ...
        <SectionHeading title="How Hastlikhit Kundali Report Works" />
      ...
      <section className="py-16 md:py-24">
        ...
        <SectionHeading title="Why Choose Hastlikhit Kundali Report?" />
        <div className="max-w-[1140px] mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-[#ebdcc7]">
            ...
            <div className="bg-white border-t md:border-t-0 md:border-l border-[#ebdcc7]">
              <div className="p-6 md:p-8 border-b border-[#ebdcc7] bg-[#5c1a1f]">
                ...
                <span className="text-[13px] md:text-[14px] text-[#e8d8c0]">Hastlikhit Kundali Report Features</span>
              </div>
              <ul className="p-6 md:p-8 space-y-4 md:space-y-5">
                {[
      ...
      <section className="py-16 md:py-24" id="faqSection">
        <Kicker text="FAQs" />
        <SectionHeading title="Personalised Hastlikhit Kundali FAQs" />
        <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div className="max-w-[900px] mx-auto px-4 md:px-6">
          <div className="bg-[#fffdf8] border border-[#ebdcc7] shadow-[0_15px_40px_rgba(0,0,0,0.05)] rounded-2xl p-8 md:p-16 text-center relative overflow-hidden">
            ...
            <a href="#order-form" className="inline-flex justify-center w-full sm:w-auto items-center gap-2 bg-[#d4af37] hover:bg-[#c29f2f] text-[#3a1216] font-bold text-[16px] md:text-[17px] px-8 md:px-10 py-4 rounded-md transition-colors shadow-md relative z-10">
              Book Now @ ₹3599 <ArrowRight className="w-5 h-5" />
            </a>
          </div>
        </div>
      </section>
