...
export default function FortuneReportCheckoutPage() {
  ...
  const finalReportName = 'Hastlikhit Kundali' 
  ...
  const { handleSubmit, isProcessing } = useReportBooking({
    ...
    amount: totalAmount,
    onSuccess: () => {
      router.push('/report/numerology/hastlikhit-kundali');
    }
  });
    ...
    <div className="min-h-screen bg-[#fdfaf6] pb-32">
      ...
      <div className="max-w-[900px] mx-auto px-4 pt-2 pb-8 md:pt-4 md:pb-12 space-y-6">
        ...
        <div className="bg-white rounded-xl border-[1.5px] border-[#c57636] p-5 md:p-8 shadow-md">
          <h2 className="text-[20px] md:text-[22px] font-bold text-[#5c1a1f] mb-8">Details Required for Hastlikhit Kundali Report</h2>
