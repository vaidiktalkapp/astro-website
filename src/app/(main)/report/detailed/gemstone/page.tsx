      ...
      <div className="max-w-[1200px] mx-auto relative z-20 -mt-6 md:-mt-10 mb-8 md:mb-12 overflow-hidden">
        ...
        <div className="md:hidden flex w-max animate-scroll gap-3 px-4 py-2 hover:[animation-play-state:paused]">
          {[1, 2].map((loop) => (
            ...
            <span className="text-[#5c1a1f] font-bold text-[13px] ">100% Based on Chart</span>
          </div>

          
              <div className="bg-white rounded-[10px] shadow-sm px-4  py-2.5  flex items-center gap-2 shrink-0 border border-[#ebdcc7]/50">
            <ShieldCheck className="w-5 h-5 text-[#d68636]" />
            <span className="text-[#5c1a1f] font-bold text-[13px] ">Avoid Costly Mistakes</span>
          </div>

          
              <div className="bg-white rounded-[10px] shadow-sm px-4  py-2.5  flex items-center gap-2 shrink-0 border border-[#ebdcc7]/50">
            <Activity className="w-5 h-5 text-[#d68636]" />
            <span className="text-[#5c1a1f] font-bold text-[13px] ">Protect Your Energy</span>
          </div>
            ...
            <span className="text-[#5c1a1f] font-bold text-[13px] ">Wearing Rules</span>
  </div>
            </React.Fragment>
          ))}
        </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            ...
            <div className="flex items-center gap-4 mb-4 md:mb-3">
              <div className="md:hidden shrink-0 w-[85px] sm:w-[100px] flex items-center justify-center">
                <img src={settings?.mockups?.pdf || "/images/vaidiktalk-kundli-mockup.webp"} alt="Premium Gemstone Report" className="w-full h-auto object-contain drop-shadow-md rounded-sm mix-blend-multiply" onError={(e) => { e.currentTarget.src = 'https://placehold.co/400x550/f8f9fa/0f3b43?text=Gemstone+Report' }} />
              </div>
              <h2 className="text-[22px] sm:text-3xl md:text-4xl font-serif font-bold text-[#5c1a1f] leading-tight">Premium Gemstone Report</h2>
            </div>
