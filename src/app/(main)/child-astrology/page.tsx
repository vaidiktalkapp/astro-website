...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const defaultMeta = {
    title: "Child Astrology & Pregnancy Predictions | AstroSolution",
...
async function fetchInitialData() {
  try {
    ...
    const [astrosRes, aiAstrosRes, settingsRes] = await Promise.all([
      ...
      fetch(`${API_URL}/smart-kundali-settings/child-astrology`, { next: { revalidate: 3600 } })
    ]);
    ...
    console.error('Error fetching SSR data for child-astrology:', error);
