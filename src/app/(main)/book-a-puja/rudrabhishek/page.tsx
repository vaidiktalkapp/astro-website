      ...
      <div className="w-full py-16 md:py-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-850 text-base md:text-lg max-w-2xl mx-auto font-medium">Different offerings during Abhishek yield specific spiritual results based on your Sankalp.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="bg-white border border-[#f0ddc0] p-6 rounded-2xl hover:border-[#d4af37]/60 hover:shadow-lg transition-all duration-300 text-center group relative overflow-hidden">
                ...
                <p className="text-gray-850 text-sm md:text-base leading-relaxed font-medium">{offering.desc}</p>
              </div>
            ))}
          </div>
        </div>
