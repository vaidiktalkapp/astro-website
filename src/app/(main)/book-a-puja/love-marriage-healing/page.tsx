...
export default function LoveHealingPage() {
  ...
  const { formData, handleChange, handleSubmit, isProcessing } = usePujaBooking({
    title: 'Love Marriage Healing',
    slug: 'love-marriage-healing',
    amount: dynamicData?.discountedPrice || dynamicData?.price || 1599
  });

  useEffect(() => {
    import('axios').then(axios => {
      const url = (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api/v1') + '/pujas/love-marriage-healing';
  ...
  return (
    <div className="w-full bg-[#fcf5eb] font-sans">
      ...
      <div className="relative w-full min-h-[500px] md:min-h-[600px] py-12 md:py-0 flex items-center bg-black overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="/pooja/Love  Marriage Healing.webp" 
            alt="Love / Marriage Healing" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="premium-serif text-3xl md:text-5xl font-bold text-[#5c1a1f] mb-6">
              Love & Marriage <br/><span className="text-[#d4af37]">Healing Pooja</span>
            </h2>
            <div className="w-20 h-1 bg-[#d4af37] mb-8" />
            <p className="text-gray-900 text-lg leading-relaxed mb-6">
              The Love & Marriage Healing Pooja is a sacred Love Healing Ritual and Relationship Puja designed to gently mend broken bonds, clear misunderstandings, and restore the soulful connection between partners. Whether you're in a committed relationship, facing distance in marriage, or healing after heartbreak, this pooja offers a spiritually guided solution to release negative karmas and emotional blockages.
            </p>
            <p className="text-gray-850 text-lg leading-relaxed mb-6">
              Guided by the divine energies of Radha-Krishna, Shiva-Parvati, and Maitri Shakti, this ritual brings Spiritual Healing for Love, clarity, and divine alignment to your relationship journey.
            </p>
            <h3 className="font-bold text-[#5c1a1f] text-xl mt-8 mb-4">Key Benefits of the Healing Pooja:</h3>
            <ul className="space-y-4">
              {[
                "Restores peace, understanding, and deep emotional connection",
                "Dissolves ego clashes, mistrust, and unresolved resentment",
                "Rekindles emotional and physical intimacy in marriage or love",
                "Brings divine guidance for forgiveness, clarity, and soul-level growth",
                "Acts as a karmic cleanser to bring fresh beginnings in your love life"
              ].map((item, i) => (
          ...
          <div className="flex flex-col gap-10">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="/pooja/Love  Marriage Healing.webp" alt="Love Marriage Healing" className="w-full h-full object-cover object-right-top aspect-square md:aspect-[4/3]" />
            ...
            <div className="p-6 md:p-8 bg-white border border-[#f0ddc0] rounded-2xl shadow-sm relative overflow-hidden group hover:border-[#d4af37]/50 transition-colors">
              ...
              <h4 className="text-xl font-bold text-[#5c1a1f] mb-3 flex items-center gap-2">
                <Sparkles className="w-5 h-5 text-[#d4af37]" /> Spiritual Foundation of the Ritual
              </h4>
              <p className="text-gray-850 leading-relaxed text-sm">
                In the Vedic tradition, relationships are not just emotional—they are karmic. When love is strained, it often reflects deeper energetic imbalances. This pooja honors and invokes the divine union of Shiva & Shakti (sacred masculine and feminine), Radha-Krishna (unconditional love), and Lakshmi-Narayan (soulful partnership) to bless you with harmony, healing, and the courage to love again.
                <br/><br/>
                <strong className="text-[#5c1a1f]">Auspicious Timing:</strong> Best performed during Purnima, Shravan Maas, or auspicious Nakshatras like Rohini and Anuradha.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        {/* How it works */}
        <div>
          <h2 className="premium-serif text-3xl md:text-4xl font-bold text-[#5c1a1f] mb-10">How Does the Healing Pooja Work?</h2>
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-[#d4af37] before:to-transparent">
            {[
              "Book the pooja easily through our sacred platform.",
              "Submit your name, gotra, and details of your love/marital situation via the form.",
              "Your Sankalp (intention) is offered by our Pandit during the start of the ritual.",
              "On pooja day, cover your head with a clean cloth, sit peacefully, and open your heart to divine healing.",
              "The pooja invokes powerful mantras, havan, and spiritual vibrations for emotional repair and reconciliation."
            ].map((step, idx) => (
        ...
        <div>
          ...
          <ul className="space-y-3 mb-10">
            {[
              "India’s most trusted devotion-tech platform for love and karmic healing rituals",
              "Live-streamed rituals with your personal Sankalp, performed by spiritually experienced Pandits",
              "40+ years of combined Vedic and emotional wisdom woven into each ritual",
              "Visual, easy-to-read Kundalis and relationship insights you can understand without needing another expert",
              "Post-pooja personalized remedies and affirmations to help you sustain emotional growth"
            ].map((item, i) => (
              ...
              <div className="bg-[#5c1a1f] p-6 md:p-8 rounded-2xl shadow-2xl text-white relative overflow-hidden">
                ...
                <div className="space-y-4 mb-6 relative z-10">
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <span className="font-bold text-right text-[15px]">Love Marriage Healing</span>
                  </div>
                  <div className="flex justify-between items-start gap-4">
    ...
    { q: "Who should book Love & Marriage Healing Puja?", a: "Couples facing relationship obstacles, families with disagreements over marriage, or individuals seeking to attract a compatible partner can benefit from this puja." },
    { q: "How does this puja help relationships?", a: "The puja invokes divine energies to dissolve karmic blockages, strengthen the emotional bond, and bring harmony and understanding between partners." },
    { q: "Is this puja effective for love marriages?", a: "Yes, it is specifically designed to ease family resistance and planetary doshas that create obstacles in love marriages." },
    { q: "Can both partners participate?", a: "Yes, both partners can join the live video link. The Sankalp is taken for both names for maximum effectiveness." }
