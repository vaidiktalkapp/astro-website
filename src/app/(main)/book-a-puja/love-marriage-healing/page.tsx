...
export default function LoveHealingPage() {
  ...
  useEffect(() => {
    const fetchPuja = async () => {
      try {
        const apiUrl = (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api/v1') + '/pujas/love-marriage-healing';
  ...
  const defaultImages = ["/pooja/Love  Marriage Healing.webp"];
  ...
  const testimonials = [
    ...
    { name: 'Rajesh Gupta', city: 'Mumbai', review: 'Skeptical at first, but this completely changed my view of online pujas. The sankalp was taken in my name and gotra. The whole process was seamless and the results were visible within a week.', initial: 'R' },
    { name: 'Anita Verma', city: 'Bengaluru', review: "Booked this puja to clear misunderstandings in our marriage. The muhurat was perfectly auspicious, the pandit spent over 2 hours performing every ritual. The difference was palpable.", initial: 'A' },
  ];
    ...
    <div className="w-full bg-white text-[#3a1216]" style={{ fontFamily: "'Be Vietnam Pro', sans-serif" }}>
      ...
      <div className="max-w-[1140px] mx-auto px-5 pb-16">
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <div className="space-y-[8px] mb-4">
              ...
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Spiritual Healing Ritual on Auspicious Muhurat
              </p>
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between my-3 gap-1 sm:gap-0 text-[15px] text-[#3a1216] font-medium">
              <span>5K+ couples blessed</span>
              <span className="text-[#9c5c0f] font-bold text-[14px]">★ 4.9 (4.8K Reviews)</span>
            </div>
            <div className="flex items-end justify-between mt-5 pt-4 border-t border-[#e5e0d8]">
              ...
              <Link href="/book-a-puja/love-marriage-healing/checkout" className="bg-[#d97706] hover:bg-[#b56003] text-white py-[13px] px-[30px] rounded-[10px] font-bold text-[16px] no-underline inline-block transition-colors mb-0">
                Book Puja
              </Link>
            </div>
          </div>
        ...
        <section className="py-12 border-t border-[#e5e0d8] mt-6">
          <h2 className="text-[28px] font-bold text-center text-[#222] mb-8">Benefits of this Healing Ritual</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {["Restores peace & understanding", "Dissolves ego & mistrust", "Rekindles emotional intimacy", "Brings clarity & forgiveness", "Clears karmic blocks"].map((b, i) => (
        ...
        <section className="py-8 border-t border-[#e5e0d8]">
          ...
          <div className="flex gap-6 flex-wrap items-start">
            <img src="/pooja/Love  Marriage Healing.webp" alt="Love Marriage Healing" className="w-full max-w-[420px] rounded-[12px] object-cover aspect-[4/3]" />
            ...
            {packages.map((pkg, i) => {
              ...
              return (
                ...
                >
                  ...
                  <Link
                    href={`/book-a-puja/love-marriage-healing/checkout?package=${pkg.name.toLowerCase()}&price=${pkg.price}`}
        ...
        <section className="py-8 border-t border-[#e5e0d8]">
          <div className="flex flex-wrap gap-4 items-center justify-between border border-[#e5e0d8] rounded-[16px] p-5 bg-[#faf6ee]">
            ...
            <div className="text-center">
              <a href="https://wa.me/919818999037?text=Hi%2C+I+want+to+book+Love+Marriage+Healing+Puja" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#25d366] hover:bg-[#1da851] text-white py-[14px] px-[32px] rounded-[12px] font-bold text-[15px] no-underline transition-colors">
                Chat on WhatsApp
              </a>
        ...
        {/* Sticky Mobile Bar */}
        <MobileStickyBar price={price} slug="love-marriage-healing" timerKey="love_healing_timer_start" />
      </div>
    </div>
  );
}
