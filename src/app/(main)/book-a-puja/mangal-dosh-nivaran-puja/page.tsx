...
export default function JobAttractPage() {
  ...
  const defaultImages = ["/pooja/Mangal Dosh Nivaran Puja.webp"];
  ...
  const faqs = [
    { q: "What is Mangal Dosha and who is affected?", a: "Mangal Dosha occurs when Mars is placed in the 1st, 4th, 7th, 8th, or 12th house in a Kundali. It can cause delays in marriage, relationship conflicts, and financial stress." },
    { q: "How does this puja remove Mangal Dosha?", a: "The puja involves specific Vedic mantras, havan, and offerings dedicated to Lord Mangal (Mars) to pacify its malefic effects and restore marital harmony." },
    { q: "Should both partners perform this puja?", a: "If both partners have Mangal Dosha, it is highly recommended both participate. However, even one partner performing it brings significant relief." },
    { q: "How do I know if I have Mangal Dosha?", a: "Our astrologers can analyze your birth chart before the booking. Reach out to us and we will guide you." },
  ];
      ...
      <div className="max-w-[1140px] mx-auto px-5 pb-16">
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <div className="space-y-[8px] mb-4">
              ...
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Special ritual on Auspicious Muhurat &amp; Shubh Nakshatra
              </p>
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Sankalp with your Name, Gotra &amp; Career intention
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between my-3 gap-1 sm:gap-0 text-[15px] text-[#3a1216] font-medium">
              <span>8K+ professionals booked this puja</span>
        ...
        <section className="py-12 border-t border-[#e5e0d8] mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {["Removes delays and obstacles in marriage", "Attracts prosperity, happiness, and harmony", "Helps overcome health challenges", "Enhances financial stability and growth", "Balances Mars energy & removes malefic influence"].map((b, i) => (
        ...
        <section className="py-8 border-t border-[#e5e0d8]">
          ...
          <div className="flex gap-6 flex-wrap items-start">
            <img src="/pooja/Mangal Dosh Nivaran Puja.webp" alt="Mangal Dosh Nivaran Puja" className="w-full max-w-[420px] rounded-[12px] object-cover aspect-[4/3]" />
            <div className="flex-1 min-w-[250px] space-y-4">
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                Mangal Dosh, also known as Kuja Dosh, is often associated with delays in marriage, relationship instability, health concerns, and financial setbacks. The Mangal Dosh Nivaran Pooja is a powerful Vedic ritual performed to pacify the negative effects of the Mars planet (Mangal) and support Manglik Dosh Removal.
              </p>
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
