...
export default function MangalDoshNivaranPage() {
  ...
  useEffect(() => {
    import('axios').then(axios => {
      const url = (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api/v1') + '/pujas/mangal-dosh-nivaran-puja';
    ...
    <div className="w-full bg-[#fcf5eb] font-sans">
      ...
      <div className="relative w-full min-h-[500px] md:min-h-[600px] py-12 md:py-0 flex items-center bg-black overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/pooja/Mangal Dosh Nivaran Puja.webp"
            alt="Mangal Dosh Nivaran Puja"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="premium-serif text-3xl md:text-5xl font-bold text-[#5c1a1f] mb-6">
              Mangal Dosh <br /><span className="text-[#d4af37]">Nivaran Puja</span>
            </h2>
            ...
            <ul className="space-y-4">
              {[
                "Removes delays and obstacles in marriage.",
                "Attracts prosperity, happiness, and harmony in personal life.",
          ...
          <div className="flex flex-col gap-10">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="/pooja/Mangal Dosh Nivaran Puja.webp" alt="Mangal Dosh Nivaran Puja" className="w-full h-full object-cover object-right-top aspect-square md:aspect-[4/3]" />
      ...
      <div className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        {/* How it works */}
        <div>
          <h2 className="premium-serif text-3xl md:text-4xl font-bold text-[#5c1a1f] mb-10">How the Pooja Works</h2>
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-[#d4af37] before:to-transparent">
            {[
              "Book the Pooja through our secure online platform.",
              ...
              "Attend the pooja live via video call from the comfort of your home.",
              "Receive divine blessings and spiritual peace.",
              "Post-Pooja: Offer the rice/flowers to a tree, donate red lentils (Masoor dal) to the underprivileged, and repeat monthly for sustained protection."
            ].map((step, idx) => (
