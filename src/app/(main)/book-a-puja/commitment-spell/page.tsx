...
export default function CommitmentSpellPage() {
  ...
  return (
    <div className="w-full bg-[#fcf5eb] font-sans">
      ...
      <div className="relative w-full min-h-[500px] md:min-h-[600px] py-12 md:py-0 flex items-center bg-black overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="/pooja/Commitment Spell.webp" 
            alt="Commitment Spell" 
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 pt-10">
          ...
          <h1 className="premium-serif text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight max-w-3xl">
            Commitment <span className="text-[#f5d08b]">Spell</span>
          </h1>
          <p className="text-[#3a1216] text-lg md:text-2xl max-w-2xl leading-relaxed mb-10 font-light">
            Invoke Loyalty, Strengthen Bonds, and Align Hearts with Devotion.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="premium-serif text-3xl md:text-5xl font-bold text-[#5c1a1f] mb-6">
              Commitment Spell <br/><span className="text-[#d4af37]">Pooja</span>
            </h2>
            <div className="w-20 h-1 bg-[#d4af37] mb-8" />
            <p className="text-gray-900 text-lg leading-relaxed mb-6">
              The Commitment Spell Pooja is a sacred Loyalty Spell and Relationship Bonding Ritual designed to foster deeper emotional connection, unwavering loyalty, and long-term harmony between two individuals. Rooted in powerful Vedic and tantric traditions, this pooja helps dissolve fears, doubts, and energetic blockages that may be preventing true commitment in a romantic or marital relationship.
            </p>
            <p className="text-gray-850 text-lg leading-relaxed mb-6">
              Whether you’re seeking to strengthen a budding relationship, rekindle dedication in a marriage, or invite a soulmate-level bond into your life, this pooja works as a divine catalyst to restore clarity, trust, and emotional security.
            </p>
            <h3 className="font-bold text-[#5c1a1f] text-xl mt-8 mb-4">Key Benefits of Commitment Spell Pooja:</h3>
            <ul className="space-y-4">
              {[
                "Strengthens loyalty, trust, and mutual understanding in a relationship",
                "Clears emotional confusion, karmic patterns, and fear of abandonment",
                "Attracts long-term partners and stabilizes uncertain romantic bonds",
                "Encourages emotional maturity and open-hearted communication",
                "Acts as a powerful spiritual remedy to deepen sacred love connections"
              ].map((item, i) => (
          ...
          <div className="flex flex-col gap-10">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="/pooja/Commitment Spell.webp" alt="Commitment Spell" className="w-full h-full object-cover object-right-top aspect-square md:aspect-[4/3]" />
            ...
            <div className="p-6 md:p-8 bg-white border border-[#f0ddc0] rounded-2xl shadow-sm relative overflow-hidden group hover:border-[#d4af37]/50 transition-colors">
              ...
              <h4 className="text-xl font-bold text-[#5c1a1f] mb-3 flex items-center gap-2">
                <Sparkles className="w-5 h-5 text-[#d4af37]" /> Understanding the Energies Behind This Spell
              </h4>
              <p className="text-gray-850 leading-relaxed text-sm">
                Commitment is not just a choice—it is an energetic alignment of two souls walking the same path. Through the use of ancient mantras, Vedic rituals, and tantric affirmations, this pooja draws blessings from deities like Katyayani Devi, Kamadeva, and Shiva-Parvati, invoking divine harmony, union, and enduring love.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        {/* How it works */}
        <div>
          <h2 className="premium-serif text-3xl md:text-4xl font-bold text-[#5c1a1f] mb-10">How Does the Pooja Process Work?</h2>
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-[#d4af37] before:to-transparent">
            {[
              "Book your Commitment Spell Pooja easily through our platform.",
              "Share your name, gotra, and the name of your partner (if applicable) through the form below for the sacred Sankalp.",
              "On the day of the pooja, prepare a clean dupatta, shawl, or cloth to respectfully cover your head and center your thoughts.",
              "Tune in with an open heart. The ritual will be performed by our experienced Panditjis on your behalf, invoking divine energies of love, harmony, and sacred union."
            ].map((step, idx) => (
        ...
        <div>
          ...
          <ul className="space-y-3 mb-10">
            {[
              "India’s most trusted Devotion-Tech platform with thousands of successful poojas performed",
              "Personalized Sankalp and live-streamed rituals for real-time connection",
              "Energetically attuned rituals designed by seasoned experts with over 40 years of combined experience",
              "Transparent process: Everything from booking to blessings is handled with spiritual integrity",
              "Visual Kundali reports & personalized remedies are offered for deeper transformation after the ritual"
            ].map((item, i) => (
              ...
              <div className="bg-[#5c1a1f] p-6 md:p-8 rounded-2xl shadow-2xl text-white relative overflow-hidden">
                ...
                <div className="space-y-4 mb-6 relative z-10">
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <span className="font-bold text-right text-[15px]">Commitment Spell</span>
                  </div>
                  <div className="flex justify-between items-start gap-4">
    ...
    { q: "What is the Commitment Spell puja?", a: "It is a sacred Vedic ritual to invoke divine energies that help strengthen the bond of trust, love, and commitment between partners." },
    { q: "How long does it take to see results?", a: "Most devotees report a noticeable shift in their relationship dynamics within 21 days of the ritual being performed." },
    { q: "Can I join the puja live?", a: "Yes, you can join via a dedicated live video link. The pandit will take the Sankalp in your name and your partner's name." },
    { q: "Is this puja safe?", a: "Absolutely. This is a pure Vedic ritual based on ancient scriptures, performed with positive intentions for love and harmony." }
