...
export default function AttractYourLoveSpellPage() {
  ...
  useEffect(() => {
    import('axios').then(axios => {
      const url = (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api/v1') + '/pujas/attract-your-love-spell';
    ...
    <div className="w-full bg-[#fcf5eb] font-sans">
      ...
      <div className="relative w-full min-h-[500px] md:min-h-[600px] py-12 md:py-0 flex items-center bg-black overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="/pooja/Attract Your Love Spell.webp" 
            alt="Attract Your Love Spell" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="premium-serif text-3xl md:text-5xl font-bold text-[#5c1a1f] mb-6">
              Attract Your <br/><span className="text-[#d4af37]">Love Spell</span>
            </h2>
            ...
            <h3 className="font-bold text-[#5c1a1f] text-xl mt-8 mb-4">Who Is This Spell For?</h3>
            <ul className="space-y-4 mb-6">
              {[
                "Singles desiring to attract a deep, meaningful relationship",
                "Those drawn to someone but unsure how to spark or deepen mutual attraction",
            ...
            <h3 className="font-bold text-[#5c1a1f] text-xl mt-8 mb-4">Key Benefits of the Love Spell:</h3>
            <ul className="space-y-4">
              {[
                "Increases your natural aura of attraction and romantic magnetism",
                "Clears emotional and energetic blocks from past love experiences",
                "Enhances confidence, self-worth, and divine feminine/masculine",
          ...
          <div className="flex flex-col gap-10">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="/pooja/Attract Your Love Spell.webp" alt="Attract Your Love Spell" className="w-full h-full object-cover object-right-top aspect-square md:aspect-[4/3]" />
      ...
      <div className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        {/* How it works */}
        <div>
          <h2 className="premium-serif text-3xl md:text-4xl font-bold text-[#5c1a1f] mb-10">How the Love Spell Ritual Works</h2>
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-[#d4af37] before:to-transparent">
            {[
              "Book your Love Spell with ease through our platform.",
              "Share your name, gotra, and your heart's current longing (whether it’s a person, type of partner, or emotional state).",
              "Your Sankalp (sacred intention) is offered during the ritual to the energies of Kama Dev, Radha-Krishna, and Venus (Shukra Graha).",
              "Our Pandit performs mantras, yantra activation, and aura-clearing havan to align your energy with loving attraction.",
              "A personalized affirmation or mantra may also be shared to keep your heart aligned post-ritual."
            ].map((step, idx) => (
        ...
        <div>
          ...
          <ul className="space-y-3 mb-10">
            {[
              "Deeply sacred yet modern spiritual approach to love attraction",
              "Authentic Vedic rituals guided by wise Pandits from Ujjain, Kashi, Rameswaram, and more",
              "Live or remote ritual options, all conducted with your personal Sankalp",
