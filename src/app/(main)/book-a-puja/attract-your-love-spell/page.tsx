...
export default function JobAttractPage() {
  ...
  const defaultImages = ["/pooja/Attract Your Love Spell.webp"];
  ...
  const faqs = [
    { q: "What is the Attract Your Love Spell puja?", a: "It is a Vedic ritual using sacred mantras and offerings to align your energy with love, making you more receptive to attracting a compatible partner." },
    { q: "Is this ethical to perform?", a: "Yes, completely. This is a pure Vedic puja performed with positive intentions — not black magic. It works by aligning your aura and karma with love energy." },
    { q: "How long does it take to show results?", a: "Results vary, but most devotees notice positive changes in their love life within 30-40 days of the puja." },
    { q: "Can I join the puja live?", a: "Yes. You will receive a live video link and the pandit will take the Sankalp in your name for personalized results." }
  ];
      ...
      <div className="max-w-[1140px] mx-auto px-5 pb-16">
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <div className="space-y-[8px] mb-4">
              ...
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Relationship-focused ritual on Auspicious Muhurat &amp; Shubh Nakshatra
              </p>
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between my-3 gap-1 sm:gap-0 text-[15px] text-[#3a1216] font-medium">
              <span>8K+ devotees booked this puja</span>
        ...
        <section className="py-12 border-t border-[#e5e0d8] mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {["Increases natural aura of romantic magnetism", "Clears emotional blocks from past love", "Enhances confidence and divine energy", "Helps draw a spiritually aligned partner", "Brings clarity on soulful connections"].map((b, i) => (
        ...
        <section className="py-8 border-t border-[#e5e0d8]">
          ...
          <div className="flex gap-6 flex-wrap items-start">
            <img src="/pooja/Attract Your Love Spell.webp" alt="Attract Your Love Spell" className="w-full max-w-[420px] rounded-[12px] object-cover aspect-[4/3]" />
            <div className="flex-1 min-w-[250px] space-y-4">
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                The Attract Your Love Spell is a sacred Vedic ritual intended to harmonize your romantic energies and draw true love into your life. Using powerful mantras dedicated to Kama Dev and Goddess Rati, it enhances your natural aura of attraction.
              </p>
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                This ritual is perfect for singles looking for a meaningful connection, or anyone seeking to heal their emotional blockages and become a magnet for a soulmate. It operates on the spiritual principle that like attracts like.
              </p>
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                Performed remotely with your personal Sankalp, this puja aligns your karmic path and removes obstacles in finding unconditional, supportive love.
              </p>
            </div>
          </div>
        </section>
