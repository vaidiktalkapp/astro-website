...
export default function GaneshLaddooPage() {
  ...
  const { formData, handleChange, handleSubmit, isProcessing } = usePujaBooking({
    ...
    amount: dynamicData?.discountedPrice || dynamicData?.price || 699
  });

  useEffect(() => {
    import('axios').then(axios => {
      const url = (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api/v1') + '/pujas/ganesh-ji-ko-laddoo-arpan';
    ...
    <div className="w-full bg-[#fcf5eb] font-sans">
      ...
      <div className="relative w-full min-h-[500px] md:min-h-[600px] py-12 md:py-0 flex items-center bg-black overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="/pooja/Ganesh Ji Ko Laddoo Arpan.webp" 
            alt="Ganesh Ji Ko Laddoo Arpan" 
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 pt-10">
          ...
          <h1 className="premium-serif text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight max-w-3xl">
            Ganesh Ji Ko <br/><span className="text-[#f5d08b]">Laddoo Arpan</span>
          </h1>
          ...
          >
            <Sparkles className="w-5 h-5" /> Book Now @ ₹699
          </a>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="premium-serif text-3xl md:text-5xl font-bold text-[#5c1a1f] mb-6">
              Ganesh Ji Ko <br/><span className="text-[#d4af37]">Laddoo Arpan</span>
            </h2>
            ...
            <h3 className="font-bold text-[#5c1a1f] text-xl mt-8 mb-4">Key Benefits of the Pooja:</h3>
            <ul className="space-y-4">
              {[
                "Removes personal, professional, and spiritual obstacles.",
                "Brings good luck, auspicious beginnings, and clarity in decision-making.",
                "Attracts prosperity, stability, and success in career and business.",
                "Symbolizes devotion and a sweet start to new journeys.",
                "Strengthens your spiritual path through Lord Ganesha’s divine grace."
              ].map((item, i) => (
          ...
          <div className="flex flex-col gap-10">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="/pooja/Ganesh Ji Ko Laddoo Arpan.webp" alt="Ganesh Ji Ko Laddoo Arpan" className="w-full h-full object-cover object-right-top aspect-square md:aspect-[4/3]" />
            ...
            <div className="p-6 md:p-8 bg-white border border-[#f0ddc0] rounded-2xl shadow-sm relative overflow-hidden group hover:border-[#d4af37]/50 transition-colors">
              ...
              <h4 className="text-xl font-bold text-[#5c1a1f] mb-3 flex items-center gap-2">
                <Sparkles className="w-5 h-5 text-[#d4af37]" /> About Lord Ganesha
              </h4>
              <p className="text-gray-850 leading-relaxed text-sm">
                Lord Ganesha, also known as Ganapati, is the revered Hindu deity symbolizing wisdom, intellect, and prosperity. The divine son of Lord Shiva and Goddess Parvati, he is worshipped first in every ritual or celebration to remove hurdles and bring success. 
                <br/><br/>
                His elephant head symbolizes knowledge and understanding, while his love for Laddoo (Modak) represents the sweetness of life when lived with faith and devotion.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-[#d4af37] before:to-transparent">
            {[
              "Book the Pooja online in a few simple steps.",
              ...
              "Attend the Pooja live via video call and participate virtually in the offerings.",
              "Receive divine blessings from Lord Ganesha as our expert Pandits perform the ritual with complete devotion and Vedic precision.",
              "Post-Pooja: Make a sincere personal resolution, chant 'Om Gan Ganapataye Namah', and repeat monthly for continuous blessings."
            ].map((step, idx) => (
            ...
            <div className="w-full lg:w-2/3 bg-white p-6 md:p-10 rounded-2xl shadow-xl border border-[#e8d8c0]/50 relative overflow-hidden">
              ...
              <form id="booking-form" onSubmit={handleSubmit} className="space-y-5 md:space-y-6 relative z-10">
                ...
                <div className="lg:hidden pt-4">
                  ...
                  >
                    <Lock className="w-5 h-5" /> Proceed to Pay ₹699
                  </button>
                </div>
              </form>
            </div>
              ...
              <div className="bg-[#5c1a1f] p-6 md:p-8 rounded-2xl shadow-2xl text-white relative overflow-hidden">
                ...
                <div className="space-y-4 mb-6 relative z-10">
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <span className="font-bold text-right text-[15px]">Laddoo Arpan</span>
                  </div>
                  <div className="flex justify-between items-start gap-4">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 p-4 shadow-[0_-10px_25px_rgba(0,0,0,0.1)] z-[100] flex justify-between items-center">
        <div className="flex flex-col">
          ...
          <div className="flex items-end gap-1.5">
            <span className="text-xl font-black text-[#5c1a1f]">₹699</span>
          </div>
        </div>
        <button 
          form="booking-form"
