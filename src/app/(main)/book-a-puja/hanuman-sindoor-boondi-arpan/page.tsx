...
export default function JobAttractPage() {
  ...
  const defaultImages = ["/pooja/Hanuman Sindoor  Boondi Puja.webp"];
  const galleryImages = dynamicData?.gallery?.length > 0 ? dynamicData.gallery : defaultImages;
  const price = dynamicData?.discountedPrice || dynamicData?.price || 899;
  ...
  const steps = [
    ...
    { title: "Enter your sankalp details", desc: "Add your Name, Gotra & intention for strength and protection. The pandit will personalize the Sankalp." },
      ...
      <div className="max-w-[1140px] mx-auto px-5 pb-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 py-2 pb-6">
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <p className="text-[#9c5c0f] font-semibold m-0 mb-4 text-[17px]">
              Sindoor and boondi arpan puja for strength, stability, and success. Let Hanumans blessings guard your life and destroy all negativity.
            </p>
            <div className="space-y-[8px] mb-4">
              ...
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Protection-focused ritual on Auspicious Muhurat &amp; Shubh Nakshatra
              </p>
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Sankalp with your Name, Gotra &amp; intention for strength and protection
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between my-3 gap-1 sm:gap-0 text-[15px] text-[#3a1216] font-medium">
              <span>12K+ devotees booked this puja</span>
              <span className="text-[#9c5c0f] font-bold text-[14px]">★ 4.8 (5.2K Reviews)</span>
            </div>
        ...
        <section className="py-12 border-t border-[#e5e0d8] mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {["Offers divine protection from negativity and enemies", "Instills courage, discipline, and determination", "Enhances focus and helps overcome anxiety", "Encourages emotional resilience and devotion", "Promotes success in challenging endeavors"].map((b, i) => (
        ...
        <section className="py-8 border-t border-[#e5e0d8]">
          ...
          <div className="flex gap-6 flex-wrap items-start">
            <img src="/pooja/Hanuman Sindoor  Boondi Puja.webp" alt="Hanuman Sindoor Boondi Arpan" className="w-full max-w-[420px] rounded-[12px] object-cover aspect-[4/3]" />
            <div className="flex-1 min-w-[250px] space-y-4">
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                The Hanuman Sindoor or Boondi Arpan Puja is a devotional offering to Lord Hanuman, known as the embodiment of strength, devotion, and unwavering faith. The Hanuman Sindoor Offering or offering of Boondi is a powerful spiritual practice believed to ward off negativity, eliminate inner fears, and bring about emotional stability.
              </p>
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
              ...
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                Join via a live video link from anywhere in the world and witness the sacred Hanuman ritual, filling your home with positive energy and divine protection.
              </p>
            </div>
          </div>
        </section>
