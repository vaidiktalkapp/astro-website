...
export default function HanumanSindoorBoondiArpanPage() {
  const [dynamicData, setDynamicData] = useState<any>(null);

  const { formData, handleChange, handleSubmit, isProcessing } = usePujaBooking({
    title: 'Hanuman Sindoor Boondi Arpan',
    slug: 'hanuman-sindoor-boondi-arpan',
    amount: dynamicData?.discountedPrice || dynamicData?.price || 899
  });

  useEffect(() => {
    import('axios').then(axios => {
      const url = (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api/v1') + '/pujas/hanuman-sindoor-boondi-arpan';
  ...
  return (
    <div className="w-full bg-[#fcf5eb] font-sans">
      ...
      <div className="relative w-full min-h-[500px] md:min-h-[600px] py-12 md:py-0 flex items-center bg-black overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="/pooja/Hanuman Sindoor  Boondi Puja.webp" 
            alt="Hanuman Sindoor / Boondi Arpan" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="premium-serif text-3xl md:text-5xl font-bold text-[#5c1a1f] mb-6">
              Hanuman Sindoor / <br/><span className="text-[#d4af37]">Boondi Arpan</span>
            </h2>
            <div className="w-20 h-1 bg-[#d4af37] mb-8" />
            <p className="text-gray-900 text-lg leading-relaxed mb-6">
              The Hanuman Sindoor or Boondi Arpan Puja is a devotional Hanuman Puja and Lord Hanuman Ritual made to Lord Hanuman, known as the embodiment of strength, devotion, and unwavering faith. The Hanuman Sindoor Offering or offering of Boondi—two items deeply associated with Lord Hanuman—is a powerful spiritual practice believed to ward off negativity, eliminate inner fears, and bring about emotional stability.
            </p>
            <p className="text-gray-850 text-lg leading-relaxed mb-6">
              This Strength and Protection Puja fosters mental clarity, confidence, and unshakeable devotion, making it ideal for those facing obstacles, emotional turbulence, or seeking divine protection.
            </p>
            
            <h3 className="font-bold text-[#5c1a1f] text-xl mt-8 mb-4">Key Benefits of the Puja:</h3>
            <ul className="space-y-4 mb-6">
              {[
                "Offers divine protection from negativity, evil influences, and hidden enemies.",
                "Instills courage, discipline, strength, and determination in the devotee.",
                "Enhances focus and helps overcome anxiety and inner restlessness.",
                "Encourages emotional resilience and spiritual devotion.",
                "Promotes success in challenging endeavors through the grace of Lord Hanuman."
              ].map((item, i) => (
            ...
            <h3 className="font-bold text-[#5c1a1f] text-xl mt-8 mb-4">Post-Puja Recommendations for Maximum Benefits:</h3>
            <ul className="space-y-4">
              {[
                "Make a sincere resolution for positive change and personal growth.",
                "Practice regular chanting of Hanuman Chalisa or “Om Hanumate Namah” to stay connected to Hanuman Ji’s divine energy.",
                "Repeat this Puja monthly, especially on Tuesdays or Saturdays, for sustained blessings and spiritual strength."
              ].map((item, i) => (
                <li key={i} className="flex items-start gap-3 text-gray-850 font-medium">
                  <CheckCircle2 className="w-6 h-6 text-[#d4af37] shrink-0" />
                  <span>{item}</span>
          ...
          <div className="flex flex-col gap-10">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="/pooja/Hanuman Sindoor  Boondi Puja.webp" alt="Hanuman Sindoor / Boondi Arpan" className="w-full h-full object-cover object-right-top aspect-square md:aspect-[4/3]" />
            ...
            <div className="p-6 md:p-8 bg-white border border-[#f0ddc0] rounded-2xl shadow-sm relative overflow-hidden group hover:border-[#d4af37]/50 transition-colors">
              ...
              <h4 className="text-xl font-bold text-[#5c1a1f] mb-3 flex items-center gap-2">
                <Sparkles className="w-5 h-5 text-[#d4af37]" /> About Lord Hanuman
              </h4>
              <p className="text-gray-850 leading-relaxed text-sm">
                Lord Hanuman, one of the most powerful and revered deities in Hinduism, is known for his unmatched devotion to Lord Rama, immense strength, and boundless energy. He represents loyalty, selfless service, humility, and is considered the ultimate protector from all forms of harm and negativity. Often depicted as a divine monkey-faced warrior, Hanuman Ji is the source of inspiration for millions who seek strength, focus, and fearlessness in the face of life’s challenges.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        {/* How it works */}
        <div>
          <h2 className="premium-serif text-3xl md:text-4xl font-bold text-[#5c1a1f] mb-10">How Will It Happen?</h2>
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-[#d4af37] before:to-transparent">
            {[
              "Book the Puja through a simple online process.",
              ...
              "Join the Puja live via video call from the comfort of your home.",
              "Be ready with a dupatta/handkerchief/towel on your head as a mark of respect before the ritual begins.",
              "Experience the divine vibrations as the Pooja is performed with utmost devotion by experienced Pandits."
            ].map((step, idx) => (
              ...
              <div className="bg-[#5c1a1f] p-6 md:p-8 rounded-2xl shadow-2xl text-white relative overflow-hidden">
                ...
                <div className="space-y-4 mb-6 relative z-10">
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <span className="font-bold text-right text-[15px]">Sindoor Boondi Arpan</span>
                  </div>
                  <div className="flex justify-between items-start gap-4">
    ...
    { q: "What are the benefits of Hanuman Sindoor & Boondi Arpan?", a: "This offering to Lord Hanuman brings protection, courage, strength, and removal of negative energies. It is especially powerful for those facing fears, health issues, or enemies." },
    { q: "On which day should this arpan be performed?", a: "Tuesdays and Saturdays are the most auspicious days for Hanuman worship. However, it can be performed any day based on urgency." },
    { q: "What do I receive after the arpan?", a: "You receive the blessed sindoor (in a sacred packet), photos and video of the ritual, and the prasad couriered to your home." },
    { q: "Can this be done online?", a: "Yes, our pandits perform the complete arpan at a Hanuman temple with a live video link for you to witness." }
