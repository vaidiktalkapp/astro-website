...
export default function JobAttractPage() {
  ...
  const defaultImages = ["/pooja/Vishnu Sahasranamam.webp"];
  const galleryImages = dynamicData?.gallery?.length > 0 ? dynamicData.gallery : defaultImages;
  const price = dynamicData?.discountedPrice || dynamicData?.price || 2499;
  ...
  const steps = [
    ...
    { title: "Enter your sankalp details", desc: "Add your Name, Gotra & intention for spiritual upliftment and peace. The pandit will personalize the Sankalp." },
      ...
      <div className="max-w-[1140px] mx-auto px-5 pb-16">
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <div className="space-y-[8px] mb-4">
              ...
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Spiritual-focused ritual on Auspicious Muhurat &amp; Shubh Nakshatra
              </p>
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Sankalp with your Name, Gotra &amp; spiritual intention
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between my-3 gap-1 sm:gap-0 text-[15px] text-[#3a1216] font-medium">
              <span>10K+ devotees booked this puja</span>
        ...
        <section className="py-12 border-t border-[#e5e0d8] mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {["Brings peace of mind and improves mental clarity", "Attracts divine protection and spiritual well-being", "Aids in overcoming financial challenges", "Offers relief from emotional distress and anxiety", "Eliminates sorrow and feelings of insecurity"].map((b, i) => (
        ...
        <section className="py-8 border-t border-[#e5e0d8]">
          ...
          <div className="flex gap-6 flex-wrap items-start">
            <img src="/pooja/Vishnu Sahasranamam.webp" alt="Vishnu Sahasranamam Puja" className="w-full max-w-[420px] rounded-[12px] object-cover aspect-[4/3]" />
            <div className="flex-1 min-w-[250px] space-y-4">
              ...
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                Join via a live video link from anywhere in the world and witness the sacred Vishnu ritual, filling your home with positive energy and divine blessings.
              </p>
            </div>
          </div>
        </section>
