...
export default function VishnuSahasranamamPujaPage() {
  ...
  const { formData, handleChange, handleSubmit, isProcessing } = usePujaBooking({
    ...
    amount: dynamicData?.discountedPrice || dynamicData?.price || 2499
  });

  useEffect(() => {
    import('axios').then(axios => {
      const url = (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api/v1') + '/pujas/vishnu-sahasranamam-puja';
  ...
  return (
    <div className="w-full bg-[#fcf5eb] font-sans">
      ...
      <div className="relative w-full min-h-[500px] md:min-h-[600px] py-12 md:py-0 flex items-center bg-black overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="/pooja/Vishnu Sahasranamam.webp" 
            alt="Vishnu Sahasranamam Puja" 
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 pt-10">
          ...
          >
            <Sparkles className="w-5 h-5" /> Book Now @ ₹2499
          </a>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="premium-serif text-3xl md:text-5xl font-bold text-[#5c1a1f] mb-6">
              Vishnu Sahasranamam <br/><span className="text-[#d4af37]">Puja</span>
            </h2>
            <div className="w-20 h-1 bg-[#d4af37] mb-8" />
            <p className="text-gray-900 text-lg leading-relaxed mb-6">
              The Vishnu Sahasranam is a revered Sanskrit stotra that comprises 1000 Names of Vishnu, the preserver of the universe. Vishnu Mantra Chanting or meditating upon these names invokes deep spiritual energy, inner peace, and divine blessings.
            </p>
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Regular recitation with devotion as part of Vishnu Puja is believed to dissolve negative energies, bring mental clarity, and foster spiritual upliftment. This powerful Spiritual Growth Ritual is especially effective in eliminating sorrow, poverty, and feelings of insecurity.
            </p>
            
            <h3 className="font-bold text-[#5c1a1f] text-xl mt-8 mb-4">Key Benefits:</h3>
            <ul className="space-y-4 mb-6">
              {[
                "Brings peace of mind and improves mental clarity and focus.",
                "Attracts divine protection, success, and spiritual well-being.",
                "Aids in overcoming financial challenges and promotes good fortune.",
                "Offers relief from emotional distress, anxiety, and negativity."
              ].map((item, i) => (
            ...
            <h3 className="font-bold text-[#5c1a1f] text-xl mt-8 mb-4">Post-Pooja Recommendations:</h3>
            <p className="text-gray-700 text-base leading-relaxed mb-4">To enhance the effects of the Pooja:</p>
            <ul className="space-y-4">
              {[
                "Maintain a clean and organized home environment, which symbolizes respect and readiness to receive divine energy.",
                "Consider repeating the Vishnu Sahasranam Pooja monthly for sustained spiritual and material benefits."
              ].map((item, i) => (
                <li key={i} className="flex items-start gap-3 text-gray-800 font-medium">
                  <CheckCircle2 className="w-6 h-6 text-[#d4af37] shrink-0" />
                  <span>{item}</span>
          ...
          <div className="flex flex-col gap-10">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="/pooja/Vishnu Sahasranamam.webp" alt="Vishnu Sahasranamam Puja" className="w-full h-full object-cover object-right-top aspect-square md:aspect-[4/3]" />
            ...
            <div className="p-6 md:p-8 bg-white border border-[#f0ddc0] rounded-2xl shadow-sm relative overflow-hidden group hover:border-[#d4af37]/50 transition-colors">
              ...
              <h4 className="text-xl font-bold text-[#5c1a1f] mb-3 flex items-center gap-2">
                <Sparkles className="w-5 h-5 text-[#d4af37]" /> About Lord Vishnu
              </h4>
              <p className="text-gray-700 leading-relaxed text-sm">
                Lord Vishnu is known as the Protector and Preserver of the universe in Hinduism. He embodies dharma (righteousness), cosmic order, and spiritual wisdom. Revered for his compassionate nature, Vishnu teaches the values of duty, devotion, and balance in life. He is often depicted alongside Goddess Lakshmi (goddess of wealth and prosperity) and his divine mount, Garuda.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        {/* How it works */}
        <div>
          <h2 className="premium-serif text-3xl md:text-4xl font-bold text-[#5c1a1f] mb-10">How the Pooja is Performed</h2>
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-[#d4af37] before:to-transparent">
            {[
              "Securely book the Pooja through our online platform.",
              ...
              "Join the Pooja live via video call and experience the sacred chanting in real time.",
              "Receive divine blessings for peace, prosperity, and protection."
            ].map((step, idx) => (
            ...
            <div className="w-full lg:w-2/3 bg-white p-6 md:p-10 rounded-2xl shadow-xl border border-[#e8d8c0]/50 relative overflow-hidden">
              ...
              <form id="booking-form" onSubmit={handleSubmit} className="space-y-5 md:space-y-6 relative z-10">
                ...
                <div className="lg:hidden pt-4">
                  ...
                  >
                    <Lock className="w-5 h-5" /> Proceed to Pay ₹2499
                  </button>
                </div>
              </form>
            </div>
              ...
              <div className="bg-[#5c1a1f] p-6 md:p-8 rounded-2xl shadow-2xl text-white relative overflow-hidden">
                ...
                <div className="space-y-4 mb-6 relative z-10">
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <span className="font-bold text-right text-[15px]">Vishnu Sahasranamam</span>
                  </div>
                  <div className="flex justify-between items-start gap-4">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 p-4 shadow-[0_-10px_25px_rgba(0,0,0,0.1)] z-[100] flex justify-between items-center">
        <div className="flex flex-col">
          ...
          <div className="flex items-end gap-1.5">
            <span className="text-xl font-black text-[#5c1a1f]">₹2499</span>
          </div>
        </div>
        <button 
          form="booking-form"
    ...
    { q: "What is Vishnu Sahasranamam Puja?", a: "It is the sacred recitation of the 1000 names of Lord Vishnu, known to bestow peace, prosperity, protection, and spiritual liberation on the devotee." },
    { q: "Who should perform this puja?", a: "Anyone seeking overall wellbeing, peace, relief from chronic health issues, or spiritual growth can benefit immensely from this puja." },
    { q: "How long does the recitation take?", a: "A complete Vishnu Sahasranamam recitation with proper rituals takes approximately 2 hours. You can witness the full process via live video." },
    { q: "What is included in the puja package?", a: "The package includes the Sahasranamam recitation, havan, personalized Sankalp, HD photos, video, and prasad delivery." }
