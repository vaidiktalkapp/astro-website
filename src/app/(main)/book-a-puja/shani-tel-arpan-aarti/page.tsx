...
export default function JobAttractPage() {
  ...
  const defaultImages = ["/pooja/Shani Tel Arpan and Aarti.webp"];
  ...
  const steps = [
    ...
    { title: "Enter your sankalp details", desc: "Add your Name, Gotra & intention for peace and Shani dosha nivaran. The pandit will personalize the Sankalp." },
      ...
      <div className="max-w-[1140px] mx-auto px-5 pb-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 py-2 pb-6">
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <p className="text-[#9c5c0f] font-semibold m-0 mb-4 text-[17px]">
              A sacred Vedic Saturn ritual to appease Shani Dev, remove obstacles, and bring peace, prosperity, and karmic balance to your life.
            </p>
            <div className="space-y-[8px] mb-4">
              ...
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Karmic-balancing ritual on Auspicious Muhurat &amp; Shubh Nakshatra
              </p>
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Sankalp with your Name, Gotra &amp; karmic intention
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between my-3 gap-1 sm:gap-0 text-[15px] text-[#3a1216] font-medium">
              <span>15K+ devotees booked this puja</span>
        ...
        <section className="py-12 border-t border-[#e5e0d8] mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {["Brings lasting happiness and prosperity", "Helps eliminate financial and life obstacles", "Offers protection from adversity and karmic setbacks", "Brings peace and stability to mind and body", "Reduces the malefic effects of Shani Dosh and Sade Sati"].map((b, i) => (
        ...
        <section className="py-8 border-t border-[#e5e0d8]">
          ...
          <div className="flex gap-6 flex-wrap items-start">
            <img src="/pooja/Shani Tel Arpan and Aarti.webp" alt="Shani Tel Arpan & Aarti" className="w-full max-w-[420px] rounded-[12px] object-cover aspect-[4/3]" />
            <div className="flex-1 min-w-[250px] space-y-4">
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                Shani Tel Arpan and Shani Aarti is a sacred Vedic Saturn Puja and Shani Dev Ritual performed to appease Shani Dev, the deity of karma, justice, and discipline. Offering mustard oil (sarson ka tel) during this ritual helps purify both mind and body, inviting peace and balance into your life.
              </p>
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                It is especially beneficial for those experiencing the effects of Shani Dosh or Sade Sati, and is believed to Remove Shani Dosh while offering Protection from Saturn. It is also believed to strengthen career, business, and financial stability.
              </p>
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                With Shani Dev's blessings, individuals may experience a rise in prosperity, clarity, and overall well-being. Join via a live video link and witness the sacred arpan from anywhere in the world.
              </p>
            </div>
          </div>
        </section>
