...
export default function RahuKetuGrahShantiPujaPage() {
  ...
  const { formData, handleChange, handleSubmit, isProcessing } = usePujaBooking({
    ...
    amount: dynamicData?.discountedPrice || dynamicData?.price || 2199
  });

  useEffect(() => {
    import('axios').then(axios => {
      const url = (process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api/v1') + '/pujas/rahu-ketu-grah-shanti-puja';
      ...
      <div className="relative w-full min-h-[500px] md:min-h-[600px] py-12 md:py-0 flex items-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 pt-10">
          ...
          <h1 className="premium-serif text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight max-w-3xl">
            Rahu Ketu Grah Shanti <span className="text-[#f5d08b]">Puja</span>
          </h1>
          ...
          >
            <Sparkles className="w-5 h-5" /> Book Now @ ₹2199
          </a>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="premium-serif text-3xl md:text-5xl font-bold text-[#5c1a1f] mb-6">
              Rahu Ketu Grah Shanti <br/><span className="text-[#d4af37]">Puja</span>
            </h2>
            <div className="w-20 h-1 bg-[#d4af37] mb-8" />
            <p className="text-gray-900 text-lg leading-relaxed mb-6">
              Rahu Ketu Dosha Puja, also known as Rahu and Ketu Shanti Pooja, is a powerful Vedic Planetary Peace Ritual dedicated to calming the disruptive energies of the shadow planets Rahu and Ketu. These celestial bodies are known to bring about karmic imbalances, delays, and unexpected challenges in one's life.
            </p>
            <p className="text-gray-850 text-lg leading-relaxed mb-6">
              By performing this pooja, individuals seek to reduce the malefic effects and align themselves with the beneficial aspects of these planets—such as heightened intuition, transformative growth, innovation, and sudden positive breakthroughs. Rahu Ketu Puja Online allows devotees to participate in this sacred ritual from anywhere. It serves as a spiritual remedy for restoring balance, clarity, and forward momentum across various areas of life.
            </p>
            
            <h3 className="font-bold text-[#5c1a1f] text-xl mt-8 mb-4">Key Benefits of This Rahu &amp; Ketu Pooja:</h3>
            <ul className="space-y-4 mb-6">
              {[
                ...
                "Supports physical and mental well-being by balancing planetary energies.",
                "Fosters peace and harmony in your personal and spiritual life."
              ].map((item, i) => (
          ...
          <div className="flex flex-col gap-10">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img src="/pooja/Rahu Ketu Grah Shanti Puja.webp" alt="Rahu Ketu Grah Shanti Puja" className="w-full h-full object-cover object-right-top aspect-square md:aspect-[4/3]" />
            ...
            <div className="p-6 md:p-8 bg-white border border-[#f0ddc0] rounded-2xl shadow-sm relative overflow-hidden group hover:border-[#d4af37]/50 transition-colors">
              ...
              <h4 className="text-xl font-bold text-[#5c1a1f] mb-3 flex items-center gap-2">
                <Sparkles className="w-5 h-5 text-[#d4af37]" /> Understanding Rahu &amp; Ketu
              </h4>
              <p className="text-gray-850 leading-relaxed text-sm">
                Rahu and Ketu are celestial shadow planets, representing the north and south lunar nodes—the intersecting points of the Moon and Sun's orbital paths. In Vedic astrology, they hold immense karmic significance and are known to influence our destiny, subconscious patterns, and spiritual evolution.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <div className="space-y-8 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-[#d4af37] before:to-transparent">
            {[
              "Book the Pooja with ease through our platform.",
              ...
              "At the beginning of the Pooja, be prepared with a dupatta, handkerchief, or towel placed respectfully on your head.",
              "Listen with devotion, participate with a pure heart, and absorb the divine energies and blessings being invoked on your behalf."
            ].map((step, idx) => (
            ...
            <div className="w-full lg:w-2/3 bg-white p-6 md:p-10 rounded-2xl shadow-xl border border-[#e8d8c0]/50 relative overflow-hidden">
              ...
              <form id="booking-form" onSubmit={handleSubmit} className="space-y-5 md:space-y-6 relative z-10">
                ...
                <div className="lg:hidden pt-4">
                  ...
                  >
                    <Lock className="w-5 h-5" /> Proceed to Pay ₹2199
                  </button>
                </div>
              </form>
            </div>
              ...
              <div className="bg-[#5c1a1f] p-6 md:p-8 rounded-2xl shadow-2xl text-white relative overflow-hidden">
                ...
                <div className="bg-white/10 p-5 rounded-xl border border-white/20 mb-6 backdrop-blur-md relative z-10">
                  ...
                  <div className="flex items-end gap-3">
                    <span className="text-4xl font-bold text-white">₹2199</span>
                  </div>
                </div>
