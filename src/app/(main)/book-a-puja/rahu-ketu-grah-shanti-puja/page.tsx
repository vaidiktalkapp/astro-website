...
/* â”€â”€â”€ Image Carousel â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€â”€ 24-hour Countdown Timer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
const CountdownTimer = () => {
  ...
  return (
    <div className="flex items-center gap-3 my-3 bg-[#fff4e0] border border-[#fcd9a0] rounded-[10px] px-4 py-[10px] w-fit">
      <span className="text-[15px] font-bold text-[#9c5c0f]">â° Offer ends in</span>
...
/* â”€â”€â”€ Mobile Sticky Booking Bar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
export default function JobAttractPage() {
  ...
  useEffect(() => {
    const fetchPuja = async () => {
      try {
        ...
        const res = await axios.get(`${apiUrl}/pujas/rudrabhishek`);
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center text-[#3a1216]/50 font-semibold">Loadingâ€¦</div>;

  const defaultImages = ["/pooja/Rahu Ketu Grah Shanti Puja.webp"];
  const galleryImages = dynamicData?.gallery?.length > 0 ? dynamicData.gallery : defaultImages;
  const price = dynamicData?.discountedPrice || dynamicData?.price || 2199;
  ...
  const steps = [
    ...
    { title: "Enter your sankalp details", desc: "Add your Name, Gotra & intention for dosha nivaran and planetary peace. The pandit will personalize the Sankalp." },
    { title: "Complete secure payment", desc: "Pay via UPI, cards, net banking â€” all methods accepted." },
  ...
  const faqs = [
    { q: "What problems does Rahu-Ketu Dosha cause?", a: "Rahu-Ketu dosha can cause sudden financial losses, health issues, relationship problems, obstacles in career, confusion, and mental unrest." },
    { q: "How does this puja pacify Rahu and Ketu?", a: "Specific Vedic mantras, havan with prescribed offerings, and rituals dedicated to Rahu and Ketu are performed to neutralize their malefic influence." },
    { q: "How do I know if I have Rahu-Ketu dosha?", a: "Our astrologers will review your birth chart before the puja. You can share your details and get a free assessment during booking." },
    { q: "Can I join the puja live?", a: "Yes, you will receive a live video link for the complete puja. The Sankalp will be taken in your name and gotra." }
  ];
      ...
      <div className="max-w-[1140px] mx-auto px-5 pb-16">
        ...
        <div className="flex flex-col md:flex-row gap-8 py-2 pb-6">
          ...
          <div className="flex-1 min-w-[280px]">
            ...
            <p className="text-[#9c5c0f] font-semibold m-0 mb-4 text-[17px]">
              Ancestral blockages, fears and delays are cleared through divine puja. Embrace spiritual growth, stability and positive transformation.
            </p>
            <div className="space-y-[8px] mb-4">
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Book Online â€” from anywhere in India
              </p>
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Planetary peace ritual on Auspicious Muhurat &amp; Shubh Nakshatra
              </p>
              <p className="flex items-center gap-2 text-[#3a1216] text-[14px] m-0 font-medium">
                ...
                Sankalp with your Name, Gotra &amp; dosh nivaran intention
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between my-3 gap-1 sm:gap-0 text-[15px] text-[#3a1216] font-medium">
              <span>18K+ devotees booked this puja</span>
              <span className="text-[#9c5c0f] font-bold text-[14px]">â˜… 4.8 (5.2K Reviews)</span>
            </div>
            <div className="flex items-end justify-between mt-5 pt-4 border-t border-[#e5e0d8]">
              <div>
                ...
                <div className="text-[28px] font-bold text-[#3a1216]">â‚¹{price}</div>
              </div>
              <Link href="/book-a-puja/job-attract-confirm-puja/checkout" className="bg-[#d97706] hover:bg-[#b56003] text-white py-[13px] px-[30px] rounded-[10px] font-bold text-[16px] no-underline inline-block transition-colors mb-0">
                Book Puja
              </Link>
            </div>
          </div>
        ...
        <section className="py-12 border-t border-[#e5e0d8] mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {["Clears obstacles that may be hindering progress", "Offers protection from negative energies and influences", "Enhances clarity and insight for confident decision-making", "Supports physical and mental well-being", "Fosters peace and harmony in personal and spiritual life"].map((b, i) => (
        ...
        <section className="py-8 border-t border-[#e5e0d8]">
          ...
          <div className="flex gap-6 flex-wrap items-start">
            <img src="/pooja/Rahu Ketu Grah Shanti Puja.webp" alt="Rahu Ketu Grah Shanti Puja" className="w-full max-w-[420px] rounded-[12px] object-cover aspect-[4/3]" />
            <div className="flex-1 min-w-[250px] space-y-4">
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                The Rahu Ketu Grah Shanti Puja is a powerful Vedic ritual combining the energies of Lord Ganesh (remover of obstacles), Goddess Lakshmi (wealth &amp; prosperity), and Surya Dev (career success). It is performed with a personalized Sankalp to remove planetary blocks causing job delays or rejections.
              </p>
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                By performing this pooja, individuals seek to reduce the malefic effects and align themselves with the beneficial aspects of these planets—such as heightened intuition, transformative growth, innovation, and sudden positive breakthroughs.
              </p>
              <p className="m-0 text-[#3a1216] text-[16px] leading-[1.8]">
                Clear your karmic obstacles and confidently step into the professional success you truly deserve.
              </p>
            </div>
          </div>
        </section>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-baseline gap-2 border-t border-[#e5e0d8] pt-3">
                    <span className="text-[22px] font-bold text-[#3a1216]">â‚¹{pkg.price}</span>
                    <span className="line-through text-[#3a1216]/40 text-[14px]">â‚¹{pkg.orig}</span>
                    {isActive && <span className="ml-auto text-[12px] font-bold text-[#d97706] bg-[#fff4e0] px-2 py-[2px] rounded-full">Selected</span>}
                  </div>
                  <Link
                    href={`/book-a-puja/job-attract-confirm-puja/checkout?package=${pkg.name.toLowerCase()}&price=${pkg.price}`}
            ...
            <div className="marquee-track gap-4">
              {[...testimonials, ...testimonials].map((t, i) => (
                <div key={i} className="min-w-[280px] max-w-[300px] border border-[#e5e0d8] rounded-[16px] p-4 shadow-[0_0_8px_rgba(0,0,0,0.06)] mx-2 bg-white">
                  <div className="text-[#d97706] text-[15px] mb-2">â˜…â˜…â˜…â˜…â˜…</div>
        ...
        <section className="py-8 border-t border-[#e5e0d8]">
          ...
          <p className="text-[#3a1216] m-0 mb-4 text-[16px] leading-[1.8]">
            Vaidik Talk is a dedicated puja platform connecting professionals with verified Pandits for authentic Vedic rituals. Every career puja is performed with a real Sankalp taken in your name and intention â€” so you can receive divine blessings from anywhere in India or abroad.
          </p>
          <p className="font-bold text-[#9c5c0f] m-0">ðŸ›¡ Guided by 40+ Years of Combined Vedic Expertise</p>
        </section>
        ...
        <section className="py-8 border-t border-[#e5e0d8]">
          <div className="flex flex-wrap gap-4 items-center justify-between border border-[#e5e0d8] rounded-[16px] p-5 bg-[#faf6ee]">
            ...
            <div className="text-center">
              <a href="https://wa.me/919818999037?text=Hi%2C+I+want+to+book+Rudrabhishek+Puja" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#25d366] hover:bg-[#1da851] text-white py-[14px] px-[32px] rounded-[12px] font-bold text-[15px] no-underline transition-colors">
                Chat on WhatsApp
              </a>
        ...
        {/* Sticky Mobile Bar */}
        <MobileStickyBar price={price} slug="job-attract-confirm-puja" timerKey="job_timer_start" />
      </div>
    </div>
  );
}
