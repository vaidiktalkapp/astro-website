...
export default function LoveCompatibilityClient({ 
  initialAstrologers = [], 
  ...
  useEffect(() => {
    ...
    const fetchSettings = async () => {
      ...
      try {
        const response = await apiClient.get('/smart-kundali-settings/love-astrology');
        if (response.data) {
        ...
        <div className="relative z-20 w-full px-6 md:px-10 mx-auto max-w-[1500px] flex-shrink-0 lg:-mt-16">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-[650px] lg:max-w-[800px]">
            ...
            <motion.h1 variants={fadeInUp} className="premium-serif font-bold text-[#3a1216] text-[38px] md:text-[56px] leading-[1.1] mb-6 tracking-tight">
              Find Clarity in Love & Compatibility <br />
      ...
      <section className="px-6 md:px-10 py-16 md:py-20 relative z-20">
        <div className="max-w-[1500px] mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-[#5e4339] text-[17px] max-w-2xl mx-auto">Select a concern to see how Vedic astrology reveals the root cause and provides practical remedies for your love life.</p>
          </div>
        ...
        <div className="max-w-[1500px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-[#5e4339] text-[17px]">Talk to verified Vedic astrologers who specialise in love compatibility, relationship remedies, and soulmate predictions.</p>
            </div>
        ...
        <div className="max-w-[1500px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-[#f0ddc0]/80 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-3">
                {[
                  { title: 'Attract Your Love Spell', link: '/book-a-puja/attract-your-love-spell' },
          ...
          {/* Top Row: Intro & Astrologer Card */}
            ...
            <div className="flex-1 w-full">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#fdf3e7] text-[#d97706] text-sm font-semibold mb-4 border border-[#f0ddc0]/50">
                <Star className="w-4 h-4" /> Why Astrology for Love?
              </div>
              <h2 className="premium-serif font-bold text-[28px] md:text-[42px] text-[#3a1216] leading-tight md:leading-[1.2] mb-5 md:mb-6">
                Decoding Your Love & Compatibility <br className="hidden md:block" />With <span className="text-[#d97706]">Vedic Astrology</span>
              </h2>
            ...
            <div className="flex-1 w-full relative mt-4 lg:mt-0">
              ...
              <div className="bg-[#fdfaf7] border border-[#f0ddc0]/80 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 shadow-[0_10px_40px_rgba(138,28,42,0.05)] relative overflow-hidden">
                ...
                <h3 className="premium-serif font-bold text-[24px] md:text-[28px] text-[#3a1216] mb-6 md:mb-8">How Our Astrologers Help Your Love Life</h3>
                <ul className="space-y-6">
                  {[
                    ...
                    { title: 'Love & Marriage Remedies', desc: 'Powerful pujas, gemstones, and rituals to attract the right partner and ensure a blissful marriage.' }].map((item, idx) => (
        ...
        <div className="max-w-[1500px] mx-auto">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white text-[#d97706] text-sm font-semibold mb-4 border border-[#f0ddc0]/80 shadow-sm">
              <Key className="w-4 h-4" /> The Secrets of Vedic Love Astrology
            </div>
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(217,119,6,0.06)] transition-all">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Venus (Shukra):</strong> The planet of love, beauty, and romance. Its placement in your chart determines your relationship style and when love will bloom.</p>
                </li>
                <li className="flex gap-3">
                  <Star className="w-5 h-5 text-[#f59e0b] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Moon (Chandra):</strong> Represents emotions, feelings, and emotional compatibility. A well-placed Moon ensures deep emotional bonding with your partner.</p>
                </li>
                <li className="flex gap-3">
                  <Star className="w-5 h-5 text-[#f59e0b] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Mars (Mangal):</strong> Governs passion, desire, and Manglik Dosh. Its placement determines the intensity and conflicts in your romantic relationships.</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(217,119,6,0.06)] transition-all">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">7th House:</strong> The 'Vivah Bhava' — the house of marriage, partnerships, and long-term commitments. This is the primary house for love and marriage.</p>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0ea5e9] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">5th House:</strong> The house of romance, dating, and new love. Strong 5th house indicates vibrant romantic opportunities and love affairs.</p>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0ea5e9] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">9th House:</strong> Represents dharma, traditions, and family values. Connected to parental blessings and approval for love marriages.</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(217,119,6,0.06)] transition-all">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Swayamvar Parvati Puja:</strong> A powerful ritual dedicated to Goddess Parvati that removes obstacles in finding the right life partner.</p>
                </li>
                <li className="flex gap-3">
                  <Heart className="w-5 h-5 text-[#d946ef] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed">
                    <strong className="text-[#3a1216]">Spiritual Remedies:</strong> Rose Quartz, Siddh Rose Quartz, or specific love-attracting bracelets can open your heart chakra and magnetize the right partner.{' '}
                ...
                <li className="flex gap-3">
                  <Heart className="w-5 h-5 text-[#d946ef] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Venus Remedies:</strong> Offering white flowers and sweets to Venus on Fridays is a simple yet extremely potent remedy for attracting love and improving relationship harmony.</p>
                </li>
              </ul>
            </div>
          </div>
