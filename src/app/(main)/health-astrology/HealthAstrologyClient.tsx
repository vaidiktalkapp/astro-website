...
const defaultFaqs = [
  { q: 'Can astrology predict health issues before they happen?', a: 'Yes. By analyzing the 6th house (disease), 8th house (longevity), and malefic transits (like Saturn or Rahu), we can predict vulnerable periods for your health and suggest preventive measures.' },
  { q: 'Which planets are responsible for poor health?', a: 'Afflicted Moon causes mental stress, a weak Sun affects immunity and vitality, while malefic Mars can cause surgeries or injuries. Rahu and Ketu are often responsible for undiagnosed or sudden illnesses.' },
  { q: 'How do Vedic remedies help in healing?', a: 'Vedic remedies like Mahamrityunjay Mantra, specific Gemstones, and Surya Arghya (offering water to the Sun) strengthen your benefic planets and pacify the malefic ones, accelerating the healing process.' },
  { q: 'Is my current illness related to my Dasha?', a: 'Often, severe health issues manifest during the Mahadasha or Antardasha of the 6th, 8th, or 12th house lords. Once the Dasha ends or is pacified, the health naturally improves.' },
  { q: 'Can astrology help with mental peace and anxiety?', a: 'Absolutely. Mental health is governed by the Moon and Mercury. By strengthening these planets through simple rituals and meditation on specific chakras, profound mental peace can be achieved.' }
];

const defaultSuccessStories = [
  {
    name: 'Sanjeev K.',
    before: '"I was suffering from chronic migraines for 3 years. No medication seemed to provide long-term relief."',
    after: '"An astrologer checked my chart and found a severely afflicted Sun. After wearing a Ruby and doing Surya Arghya, my migraines reduced by 90%!"'
  },
  {
    name: 'Meena R.',
    before: '"My anxiety was out of control, and I couldn\'t sleep at night due to constant overthinking."',
    after: '"I learned my Moon was with Rahu (Grahan Yog). A simple Shiva remedy on Mondays brought me immense peace and deep sleep."'
  },
  {
    name: 'Rajesh S.',
    before: '"I had a sudden, undiagnosed stomach issue that kept me hospitalized for weeks."',
    after: '"Kundali analysis revealed a harsh Ketu transit over my 6th house. I performed the suggested donation remedy, and my reports finally came clear."'
  },
  {
    name: 'Anjali M.',
  ...
  {
    name: 'Vivek T.',
    before: '"I felt constantly lethargic, weak, and depressed despite taking all vitamins."',
    after: '"The astrologer identified a weak Mars and advised wearing a copper ring. Within a week, my energy levels and confidence shot up!"'
  },
  {
    name: 'Sunita D.',
    before: '"We were facing unexplained fertility issues for 5 years despite all medical tests being normal."',
    after: '"A 5th house Jupiter remedy was suggested. Fast forward 1 year, we are now blessed with a beautiful baby girl!"'
  }
];

export default function HealthAstrologyClient({ 
  initialAstrologers = [], 
  ...
  useEffect(() => {
    ...
    const fetchSettings = async () => {
      ...
      try {
        const response = await apiClient.get('/smart-kundali-settings/health-astrology');
        if (response.data) {
  ...
  const problems = [
    ...
    },
    {
      ...
      content: 'A strong Mars transit over the 8th house can indicate injuries. By foreseeing these periods, you can take precautions and perform protective rituals.',
  ...
  return (
    <div className="relative w-full max-w-[1600px] min-w-[320px] mx-auto overflow-hidden bg-transparent font-sans">
      ...
      <section className="relative w-full min-h-[550px] lg:min-h-[600px] flex flex-col lg:flex-row lg:items-center overflow-hidden pt-12 md:py-16 lg:py-20 z-10">
        ...
        <div className="absolute inset-0 z-0 hidden lg:flex justify-end pointer-events-none">
          <motion.img
            ...
            src={banner?.url || "/images/health-wellness-hero.webp?v=2"}
            alt="Health & Wellness Astrology Consultation"
        ...
        <div className="relative z-20 w-full px-6 md:px-10 mx-auto max-w-[1500px] flex-shrink-0 lg:-mt-16">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-[650px] lg:max-w-[800px]">
            ...
            <motion.h1 variants={fadeInUp} className="premium-serif font-bold text-[#3a1216] text-[38px] md:text-[56px] leading-[1.1] mb-6 tracking-tight">
              Restore Health & Wellness <br />
              <span className="relative inline-block mt-2">
                <span className="text-[#059669]">Through Vedic Astrology</span>
            ...
            <motion.p variants={fadeInUp} className="text-[#5e4339] text-[16px] md:text-[18px] leading-relaxed mb-8 max-w-[550px] font-medium">
              Whether you are suffering from unexplained illnesses, chronic anxiety, seeking remedies for vitality, or want to know the best periods for surgery — your Kundali holds precise, healing answers.
            </motion.p>
        ...
        <div className="max-w-[1500px] mx-auto">
          <div className="text-center mb-14">
            <h2 className="premium-serif font-bold text-[36px] md:text-[42px] text-[#3a1216] mb-4">
              Answers to Your <span className="text-[#059669]">Health & Wellness Concerns</span>
            </h2>
            <p className="text-[#5e4339] text-[17px] max-w-2xl mx-auto">Select a concern to see how Vedic astrology reveals the root cause and provides practical remedies for your health.</p>
          </div>
      ...
      <section className="px-6 md:px-10 py-12 md:py-16 bg-transparent">
        <div className="max-w-[1500px] mx-auto text-center">
          <h2 className="premium-serif font-bold text-[32px] md:text-[38px] text-[#3a1216] mb-3">
            Instantly Gain <span className="text-[#059669]">Clarity</span>
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { title: 'Health Prediction', desc: 'Check your disease vulnerability', icon: <Heart className="w-7 h-7" />, link: '/kundli', color: 'bg-green-50', text: 'text-[#059669]' },
              ...
              { title: 'Daily Horoscope', desc: 'Today\'s wellness insights', icon: <Sparkles className="w-7 h-7" />, link: '/daily-horoscope', color: 'bg-blue-50', text: 'text-[#0284c7]' }
            ].map((tool, i) => (
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
            <div className="max-w-2xl">
              <h2 className="premium-serif font-bold text-[36px] md:text-[42px] text-[#3a1216] mb-3">
                Consult Health & Wellness <span className="text-[#059669]">Specialists</span>
              </h2>
              <p className="text-[#5e4339] text-[17px]">Talk to verified Vedic astrologers who specialise in medical astrology, healing remedies, and longevity predictions.</p>
            </div>
      ...
      <section className="px-6 md:px-10 py-16 md:py-20 border-t border-[#f0ddc0]/50">
        <div className="max-w-[1500px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
            <div className="max-w-2xl">
              <h2 className="premium-serif font-bold text-[36px] md:text-[42px] text-[#3a1216] mb-3">
                Ask Our <span className="text-[#059669]">AI Astrologers</span>
              </h2>
              <p className="text-[#5e4339] text-[17px]">Get instant, personalized answers to your health questions from our advanced AI astrologers, available 24/7.</p>
            </div>
            <div className="flex items-center gap-4">
              <div className="flex gap-2 shrink-0">
        ...
        <div className="max-w-[1500px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-[#f0ddc0]/80 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-3">
                {[
                  { title: 'Rudrabhishek', link: '/book-a-puja/rudrabhishek' },
                  { title: 'Rahu Ketu Grah Shanti Puja', link: '/book-a-puja/rahu-ketu-grah-shanti-puja' },
                  { title: 'Hanuman Sindoor Boondi Arpan', link: '/book-a-puja/hanuman-sindoor-boondi-arpan' }
                ].map((rep, i) => (
                  <Link href={rep.link} key={i} className="flex items-center justify-between p-4 rounded-xl bg-transparent border border-[#f0ddc0]/50 hover:bg-[#fdf8f0] hover:border-[#d97706] group transition-all duration-300">
                    <div className="font-semibold text-[#3a1216] group-hover:text-[#d97706] transition-colors text-[15px]">{rep.title}</div>
                    <ArrowRight className="w-5 h-5 text-[#d97706] group-hover:translate-x-1 transition-transform shrink-0 ml-4" />
        ...
        <div className="max-w-[1500px] mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start mb-12 md:mb-16">
            <div className="flex-1 w-full">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#fdf3e7] text-[#059669] text-sm font-semibold mb-4 border border-[#f0ddc0]/50">
                <Star className="w-4 h-4" /> Why Astrology for Health?
              </div>
              <h2 className="premium-serif font-bold text-[28px] md:text-[42px] text-[#3a1216] leading-tight md:leading-[1.2] mb-5 md:mb-6">
                Decoding Your Health & Wellness <br className="hidden md:block" />With <span className="text-[#059669]">Vedic Astrology</span>
              </h2>
              <p className="text-[#5e4339] text-[15.5px] md:text-[17px] leading-relaxed mb-4">
                Your physical vitality, immunity, and susceptibility to certain diseases are directly linked to the planetary positions at your birth. Medical astrology (Ayurjyotish) is an ancient branch of Vedic science that maps your health profile, identifies weak organs, and predicts periods of potential illness before they manifest.
              </p>
              <p className="text-[#5e4339] text-[16px] md:text-[17px] leading-relaxed">
                The <strong className="text-[#3a1216]">6th House</strong> (Rog Bhava) represents diseases, while the <strong className="text-[#3a1216]">8th House</strong> governs longevity and chronic issues. By analyzing these houses along with the Sun (vitality) and Moon (mental health), an expert astrologer can suggest precise remedies to mitigate health risks and accelerate healing.
              </p>
            </div>
            ...
            <div className="flex-1 w-full relative mt-4 lg:mt-0">
              ...
              <div className="bg-[#fdfaf7] border border-[#f0ddc0]/80 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 shadow-[0_10px_40px_rgba(138,28,42,0.05)] relative overflow-hidden">
                ...
                <h3 className="premium-serif font-bold text-[24px] md:text-[28px] text-[#3a1216] mb-6 md:mb-8">How Astrologers Help Your Health</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            ...
            <div className="p-6 md:p-8 rounded-[1.5rem] bg-[#fdfaf7] border border-[#f0ddc0]/80 shadow-[0_4px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_25px_rgba(5,150,105,0.08)] hover:border-[#059669]/40 transition-all duration-300 group">
              <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center mb-5 text-[#059669] group-hover:scale-110 transition-transform duration-300">
                <Heart className="w-6 h-6" />
              </div>
              <h3 className="premium-serif font-bold text-[22px] md:text-[24px] text-[#3a1216] mb-3">Chronic Illnesses & The 6th House</h3>
              <p className="text-[#5e4339] text-[14.5px] md:text-[15.5px] leading-relaxed">
                The 6th house is the primary indicator of diseases. If malefic planets like Saturn, Rahu, or Mars afflict this house, you may suffer from chronic or undiagnosed illnesses. Analyzing the 6th lord's placement helps astrologers suggest specific rituals to pacify these negative influences.
              </p>
            </div>
            ...
            <div className="p-6 md:p-8 rounded-[1.5rem] bg-[#fdfaf7] border border-[#f0ddc0]/80 shadow-[0_4px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_25px_rgba(2,132,199,0.08)] hover:border-[#0284c7]/40 transition-all duration-300 group">
              <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center mb-5 text-[#0284c7] group-hover:scale-110 transition-transform duration-300">
                <Moon className="w-6 h-6" />
              </div>
              <h3 className="premium-serif font-bold text-[22px] md:text-[24px] text-[#3a1216] mb-3">Mental Health & Moon</h3>
              <p className="text-[#5e4339] text-[14.5px] md:text-[15.5px] leading-relaxed">
                In Vedic Astrology, the Moon represents the mind (Manas). When the Moon is weak, combust, or conjunct with Rahu/Ketu (forming Grahan Dosha), it leads to extreme anxiety, depression, and insomnia. Strengthening the Moon through silver remedies or Shiva worship can bring immediate relief.
              </p>
            </div>
            ...
            <div className="p-6 md:p-8 rounded-[1.5rem] bg-[#fdfaf7] border border-[#f0ddc0]/80 shadow-[0_4px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_25px_rgba(225,29,72,0.08)] hover:border-[#e11d48]/40 transition-all duration-300 group">
              ...
              <h3 className="premium-serif font-bold text-[22px] md:text-[24px] text-[#3a1216] mb-3">Sun: The Indicator of Vitality</h3>
              <p className="text-[#5e4339] text-[14.5px] md:text-[15.5px] leading-relaxed">
                The Sun (Surya) is the Karak of health, immunity, and bone strength. A weak or debilitated Sun in your Kundali results in frequent sickness, lethargy, and lack of confidence. Wearing a high-quality Ruby (Manik) or chanting the Aditya Hridaya Stotram can significantly boost your natural immunity.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 md:px-10 py-16 md:py-20 bg-transparent border-t border-[#f0ddc0]/50 relative overflow-hidden">
        ...
        <div className="max-w-[1500px] mx-auto">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white text-[#059669] text-sm font-semibold mb-4 border border-[#f0ddc0]/80 shadow-sm">
              <Key className="w-4 h-4" /> The Secrets of Medical Astrology
            </div>
            <h2 className="premium-serif font-bold text-[32px] md:text-[40px] text-[#3a1216] mb-4 leading-tight">
              Planets, Houses & <span className="text-[#059669]">Healing Remedies</span>
            </h2>
            <p className="text-[#5e4339] text-[16.5px] max-w-3xl mx-auto leading-relaxed">
              Vedic Astrology provides a surgical analysis of your health destiny. Our experts decode the precise geometric alignments of the Sun, Mars, and specific Bhavas (houses) in your Kundali to reveal the absolute truth about your physical and mental well-being.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(5,150,105,0.06)] transition-all">
              <div className="w-14 h-14 bg-[#fff8f0] rounded-2xl flex items-center justify-center mb-6 border border-[#f0ddc0]/50">
                <Sun className="w-7 h-7 text-[#059669]" />
              </div>
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Sun (Surya):</strong> The karaka (significator) of general vitality, immunity, and bone health. A strong Sun means a strong body.</p>
                </li>
                <li className="flex gap-3">
                  <Star className="w-5 h-5 text-[#f59e0b] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Moon (Chandra):</strong> Represents the mind and bodily fluids. Afflictions here cause anxiety, depression, and hormonal imbalances.</p>
                </li>
                <li className="flex gap-3">
                  <Star className="w-5 h-5 text-[#f59e0b] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Mars (Mangal):</strong> Governs blood, muscles, and surgeries. A malefic Mars transit often triggers injuries or the need for operations.</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(5,150,105,0.06)] transition-all">
              ...
              <h3 className="premium-serif font-bold text-[22px] text-[#3a1216] mb-4">Crucial Medical Houses</h3>
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0ea5e9] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">6th House:</strong> The 'Rog Bhava' — the primary house of diseases, daily health habits, and short-term illnesses.</p>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0ea5e9] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">8th House:</strong> The house of longevity, chronic diseases, and sudden surgeries. Planets here determine the severity of illnesses.</p>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0ea5e9] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">12th House:</strong> Represents hospitalization, bed rest, and spiritual healing. It shows if an illness will require medical confinement.</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(5,150,105,0.06)] transition-all">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Mahamrityunjay Puja:</strong> The ultimate life-saving ritual dedicated to Lord Shiva, highly effective in curing severe and chronic illnesses.</p>
                </li>
                <li className="flex gap-3">
                  <Heart className="w-5 h-5 text-[#d946ef] shrink-0 mt-0.5" />
                ...
                <li className="flex gap-3">
                  <Heart className="w-5 h-5 text-[#d946ef] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Planetary Donations:</strong> Specific charities (Daan) related to the afflicted planet (e.g., donating black sesame for Saturn) can significantly reduce health struggles.</p>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-[1500px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
            <div className="max-w-2xl text-left">
              ...
              <p className="text-[#5e4339] text-[16.5px]">See how Vedic astrology transformed the love lives of our clients.</p>
            </div>
