...
export default function EducationAstrologyClient({ 
  initialAstrologers = [], 
      ...
      <section className="relative w-full min-h-[550px] lg:min-h-[600px] flex flex-col lg:flex-row lg:items-center overflow-hidden pt-12 md:py-16 lg:py-20 z-10">
        ...
        <div className="absolute inset-0 z-0 hidden lg:flex justify-end pointer-events-none">
          <motion.img
            ...
            src={banner?.url || "/images/education.webp"}
            alt="Education & Study Astrology Consultation"
        ...
        <div className="relative z-20 w-full px-6 md:px-10 mx-auto max-w-[1500px] flex-shrink-0 lg:-mt-16">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-[650px] lg:max-w-[800px]">
            ...
            <motion.h1 variants={fadeInUp} className="premium-serif font-bold text-[#3a1216] text-[38px] md:text-[56px] leading-[1.1] mb-6 tracking-tight">
              Achieve Excellence in Education & Study <br />
            ...
            <motion.p variants={fadeInUp} className="text-[#5e4339] text-[16px] md:text-[18px] leading-relaxed mb-8 max-w-[550px] font-medium">
              Whether you are struggling with concentration, confused about which stream to choose, facing obstacles in competitive exams, or dreaming of studying abroad — your Kundali holds precise answers.
            </motion.p>
        ...
        <div className="max-w-[1500px] mx-auto">
          <div className="text-center mb-14">
            <h2 className="premium-serif font-bold text-[36px] md:text-[42px] text-[#3a1216] mb-4">
              Answers to Your <span className="text-[#ee6c1e]">Education & Study Concerns</span>
            </h2>
            <p className="text-[#5e4339] text-[17px] max-w-2xl mx-auto">Select a concern to see how Vedic astrology reveals the root cause and provides practical remedies for your education.</p>
          </div>
      ...
      <section className="px-6 md:px-10 py-12 md:py-16 bg-transparent">
        <div className="max-w-[1500px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { title: 'Education Prediction', desc: 'Check your academic block vulnerability', icon: <Heart className="w-7 h-7" />, link: '/kundli', color: 'bg-green-50', text: 'text-[#ee6c1e]' },
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
            <div className="max-w-2xl">
              <h2 className="premium-serif font-bold text-[36px] md:text-[42px] text-[#3a1216] mb-3">
                Consult Education & Study <span className="text-[#ee6c1e]">Specialists</span>
              </h2>
              <p className="text-[#5e4339] text-[17px]">Talk to verified Vedic astrologers who specialise in medical astrology, learning remedies, and longevity predictions.</p>
            </div>
        ...
        <div className="max-w-[1500px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-[#5e4339] text-[17px]">Get instant, personalized answers to your education questions from our advanced AI astrologers, available 24/7.</p>
            </div>
            <div className="flex items-center gap-4">
              <div className="flex gap-2 shrink-0">
        ...
        <div className="max-w-[1500px] mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start mb-12 md:mb-16">
            <div className="flex-1 w-full">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#fdf3e7] text-[#ee6c1e] text-sm font-semibold mb-4 border border-[#f0ddc0]/50">
                <Star className="w-4 h-4" /> Why Astrology for Education?
              </div>
              <h2 className="premium-serif font-bold text-[28px] md:text-[42px] text-[#3a1216] leading-tight md:leading-[1.2] mb-5 md:mb-6">
                Decoding Your Education & Study <br className="hidden md:block" />With <span className="text-[#ee6c1e]">Vedic Astrology</span>
              </h2>
              <p className="text-[#5e4339] text-[15.5px] md:text-[17px] leading-relaxed mb-4">
                Your physical focus, immunity, and susceptibility to certain learning obstacles are directly linked to the planetary positions at your birth. Medical astrology (Ayurjyotish) is an ancient branch of Vedic science that maps your education profile, identifies weak organs, and predicts periods of potential academic issue before they manifest.
              </p>
              <p className="text-[#5e4339] text-[16px] md:text-[17px] leading-relaxed">
                The <strong className="text-[#3a1216]">6th House</strong> (Rog Bhava) represents learning obstacles, while the <strong className="text-[#3a1216]">8th House</strong> governs longevity and chronic issues. By analyzing these houses along with the Sun (focus) and Moon (mental education), an expert astrologer can suggest precise remedies to mitigate education risks and accelerate learning.
              </p>
            </div>
            ...
            <div className="flex-1 w-full relative mt-4 lg:mt-0">
              ...
              <div className="bg-[#fdfaf7] border border-[#f0ddc0]/80 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 shadow-[0_10px_40px_rgba(138,28,42,0.05)] relative overflow-hidden">
                ...
                <h3 className="premium-serif font-bold text-[24px] md:text-[28px] text-[#3a1216] mb-6 md:mb-8">How Astrologers Help Your Education</h3>
                <ul className="space-y-6">
                  {[
                    { title: 'academic block Prediction', desc: 'Identify potential education issues years before they manifest physically.' },
                    { title: 'Mental Education Guidance', desc: 'Understand the root cause of anxiety and depression through Moon analysis.' },
                    { title: 'Timing of Surgery/Treatment', desc: 'Find the most auspicious time (Muhurat) for surgeries to ensure quick recovery.' },
                    { title: 'Vedic learning Remedies', desc: 'Powerful pujas, rudraksha, and gemstone therapy to strengthen weak planets and boost immunity.' }].map((item, idx) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            ...
            <div className="p-6 md:p-8 rounded-[1.5rem] bg-[#fdfaf7] border border-[#f0ddc0]/80 shadow-[0_4px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_25px_rgba(5,150,105,0.08)] hover:border-[#059669]/40 transition-all duration-300 group">
              ...
              <h3 className="premium-serif font-bold text-[22px] md:text-[24px] text-[#3a1216] mb-3">5th House: Intelligence & Memory</h3>
              <p className="text-[#5e4339] text-[14.5px] md:text-[15.5px] leading-relaxed">
                The 5th house is the primary indicator of your natural intellect, memory, and primary education. A strong 5th house ensures quick learning and good academic performance, while afflictions from Rahu or Saturn can cause memory lapses and lack of concentration.
              </p>
            </div>
            ...
            <div className="p-6 md:p-8 rounded-[1.5rem] bg-[#fdfaf7] border border-[#f0ddc0]/80 shadow-[0_4px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_25px_rgba(2,132,199,0.08)] hover:border-[#0284c7]/40 transition-all duration-300 group">
              ...
              <h3 className="premium-serif font-bold text-[22px] md:text-[24px] text-[#3a1216] mb-3">Mercury: The Planet of Learning</h3>
              <p className="text-[#5e4339] text-[14.5px] md:text-[15.5px] leading-relaxed">
                Mercury (Budh) governs logic, analytical skills, and communication. An exalted Mercury creates a brilliant student. If Mercury is weak or combust, it leads to confusion in choosing subjects and difficulty in subjects like Mathematics and Science.
              </p>
            </div>
            ...
            <div className="p-6 md:p-8 rounded-[1.5rem] bg-[#fdfaf7] border border-[#f0ddc0]/80 shadow-[0_4px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_25px_rgba(225,29,72,0.08)] hover:border-[#e11d48]/40 transition-all duration-300 group">
              ...
              <h3 className="premium-serif font-bold text-[22px] md:text-[24px] text-[#3a1216] mb-3">9th House: Higher Studies & Abroad</h3>
              <p className="text-[#5e4339] text-[14.5px] md:text-[15.5px] leading-relaxed">
                Want to pursue a Master's degree or study in a foreign university? The 9th house holds the answer. Positive transits over the 9th and 12th houses unlock opportunities for international education and academic scholarships.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1500px] mx-auto">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white text-[#ee6c1e] text-sm font-semibold mb-4 border border-[#f0ddc0]/80 shadow-sm">
              <Key className="w-4 h-4" /> The Secrets of Educational Astrology
            </div>
            <h2 className="premium-serif font-bold text-[32px] md:text-[40px] text-[#3a1216] mb-4 leading-tight">
              Planets, Houses & <span className="text-[#ee6c1e]">Academic Success</span>
            </h2>
            <p className="text-[#5e4339] text-[16.5px] max-w-3xl mx-auto leading-relaxed">
              Vedic Astrology provides a precise analysis of your educational destiny. Our experts decode the alignments of Mercury, Jupiter, and specific Bhavas (houses) in your Kundali to reveal the absolute truth about your learning potential and career path.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(5,150,105,0.06)] transition-all">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Mercury (Budh):</strong> The karaka of intellect and memory. A strong Mercury is crucial for passing competitive exams.</p>
                </li>
                <li className="flex gap-3">
                  <Star className="w-5 h-5 text-[#f59e0b] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Jupiter (Guru):</strong> Represents wisdom, knowledge, and higher education. It blesses the student with the right guidance.</p>
                </li>
                <li className="flex gap-3">
                  <Star className="w-5 h-5 text-[#f59e0b] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Moon (Chandra):</strong> Controls mental focus. If afflicted, the student will suffer from a wandering mind and exam anxiety.</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(5,150,105,0.06)] transition-all">
              ...
              <h3 className="premium-serif font-bold text-[22px] text-[#3a1216] mb-4">Crucial Education Houses</h3>
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0ea5e9] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">4th House:</strong> Represents basic education up to high school and your foundational learning environment.</p>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0ea5e9] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">5th House:</strong> The house of intelligence, memory, and undergraduate degrees. Crucial for choosing the right stream.</p>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#0ea5e9] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">9th House:</strong> Represents higher studies, Master's degrees, Ph.D., and education in foreign countries.</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#fdfaf7] p-8 rounded-3xl border border-[#f0ddc0]/80 shadow-[0_8px_30px_rgba(138,28,42,0.03)] hover:shadow-[0_8px_30px_rgba(5,150,105,0.06)] transition-all">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Saraswati Puja:</strong> Worshiping the Goddess of knowledge removes ignorance and dramatically improves focus and academic results.</p>
                </li>
                <li className="flex gap-3">
                  <Heart className="w-5 h-5 text-[#d946ef] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed">
                    <strong className="text-[#3a1216]">Gemstone Therapy:</strong> Wearing an Emerald (Panna) for Mercury or a Yellow Sapphire (Pukhraj) for Jupiter can unlock hidden academic potential.{' '}
                ...
                <li className="flex gap-3">
                  <Heart className="w-5 h-5 text-[#d946ef] shrink-0 mt-0.5" />
                  <p className="text-[#5e4339] text-[14.5px] leading-relaxed"><strong className="text-[#3a1216]">Mantra Chanting:</strong> Daily chanting of the Gayatri Mantra or Saraswati Beej Mantra sharpens the intellect and calms pre-exam anxiety.</p>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-[800px] mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="#" className="w-full sm:w-auto inline-flex justify-center items-center bg-[#8a1c2a] text-white font-bold px-8 py-4 rounded-xl hover:bg-[#721522] hover:-translate-y-1 transition-all shadow-[0_8px_20px_rgba(138,28,42,0.15)] text-[16px]">
              Talk to a Education Astrologer
            </Link>
