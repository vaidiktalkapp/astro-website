                        ...
                        >
                            <div className="flex items-center gap-5">
                                ...
                                <div className="text-left">
                                    <h3 className="text-xl font-bold serif text-[#3a1216] group-hover:text-[#b8962e] transition-colors">{t("planets.back_to_astrology_lessons")}</h3>
                                    <p className="text-[14px] text-gray-600 font-medium mt-1">{t("planets.continue_your_sequential_learn")}</p>
                                </div>
                            </div>
