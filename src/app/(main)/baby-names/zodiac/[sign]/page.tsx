        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
          <div className="text-left">
            ...
            <div className="text-left">
              ...
              <p className="text-gray-850 text-sm">{total}{t("_sign_.names_found")}</p>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm border border-[#d6c89a] rounded-3xl p-6 md:p-8 shadow-lg shadow-[#b8962e]/5">
            <AnimatePresence mode="wait">
              ...
              <motion.div key="empty" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-left py-16">
                  ...
                  <p className="text-gray-850 serif text-lg">{t("_sign_.no_names_found_for")}{sign}.</p>
                  <p className="text-[#3a1216] text-sm mt-1">{t("_sign_.names_will_appear_here_once_ad")}</p>
                </motion.div> :
              ...
              <motion.div key="results" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                ...
                <div className="flex items-center justify-between mt-8 pt-6 border-t border-[#d6c89a]/20">
                      <p className="text-xs text-[#3a1216] font-semibold">{t("_sign_.page")}{page} of {totalPages}</p>
